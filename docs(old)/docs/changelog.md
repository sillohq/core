...
* (types): introduce ArgsType for route model arguments ([#396](https://github.com/sillo-labs/sillo/issues/396))
#### Refactorings

* remove unused imports and simplify types ([#397](https://github.com/sillo-labs/sillo/issues/397))
* replace print with logger.info for server start message ([#395](https://github.com/sillo-labs/sillo/issues/395))
#### Docs

* (changelog): update changelog with recent releases ([#393](https://github.com/sillo-labs/sillo/issues/393))
#### Others

* bump version to 3.12.1

Full set of changes: [`v3.12.0...v3.12.1`](https://github.com/sillo-labs/sillo/compare/v3.12.0...v3.12.1)

## v3.12.0 (2026-05-08)

#### New Features

* add support for Query, Header, and Cookie parameters ([#370](https://github.com/sillo-labs/sillo/issues/370))
#### Fixes

* (static): improve path safety check for static files serving ([#389](https://github.com/sillo-labs/sillo/issues/389))
* update config docs ([#387](https://github.com/sillo-labs/sillo/issues/387))
* (docs): fix syntax error in readme ([#371](https://github.com/sillo-labs/sillo/issues/371))
* (headers): fix set_header multi set issues ([#369](https://github.com/sillo-labs/sillo/issues/369))
#### Refactorings

* (auth): remove unused response parameter from authenticate methods ([#392](https://github.com/sillo-labs/sillo/issues/392))
* (auth): raise value error when auth middleware not installed  ([#391](https://github.com/sillo-labs/sillo/issues/391))
* (application): simplify OpenAPI config ([#386](https://github.com/sillo-labs/sillo/issues/386))
* (cors): cleanup cors config ([#385](https://github.com/sillo-labs/sillo/issues/385))
* (auth): rewrite use of secret_keys ([#384](https://github.com/sillo-labs/sillo/issues/384))
* redesign session system with pluggable persistence and custom config support ([#380](https://github.com/sillo-labs/sillo/issues/380))
* remove depricated config style ([#379](https://github.com/sillo-labs/sillo/issues/379))
* (context): Moved context logic into a dedicated module ([#376](https://github.com/sillo-labs/sillo/issues/376))
* fix debug issues in server error handler ([#375](https://github.com/sillo-labs/sillo/issues/375))
* (routing): improve parameter injection in route handler ([#373](https://github.com/sillo-labs/sillo/issues/373))
* (dependencies): fix import issues ([#372](https://github.com/sillo-labs/sillo/issues/372))
#### Docs

* update configuration and authentication examples ([#388](https://github.com/sillo-labs/sillo/issues/388))
* (sillo): add docstrings to public APIs ([#374](https://github.com/sillo-labs/sillo/issues/374))
#### Others

* bump version from 3.12.0rc2 to 3.12.0
* bump version to 3.12.0rc2
* (release): bump version to 3.12.0rc1
* update silloApp initialization in CSRF tests ([#382](https://github.com/sillo-labs/sillo/issues/382))
* (csrf): enable and fix CSRF middleware tests ([#381](https://github.com/sillo-labs/sillo/issues/381))

Full set of changes: [`v3.11.4...v3.12.0`](https://github.com/sillo-labs/sillo/compare/v3.11.4...v3.12.0)

## v3.11.4 (2026-04-13)

#### Fixes

* remove type ignores due to fixes on [#363](https://github.com/sillo-labs/sillo/issues/363) ([#364](https://github.com/sillo-labs/sillo/issues/364))
#### Refactorings

* (openapi): rename schema to spec to avoid issues with ty ([#368](https://github.com/sillo-labs/sillo/issues/368))
* (sillo): allow lifespan to yield any ([#363](https://github.com/sillo-labs/sillo/issues/363))
#### Docs

* (changelog): update changelog with recent releases ([#362](https://github.com/sillo-labs/sillo/issues/362))
#### Others

* (release): bump version to 3.11.4

Full set of changes: [`v3.11.3...v3.11.4`](https://github.com/sillo-labs/sillo/compare/v3.11.3...v3.11.4)

## v3.11.3 (2026-04-10)

#### New Features

* (http): enhance redirect method with route name support ([#361](https://github.com/sillo-labs/sillo/issues/361))
#### Fixes

* (cli): update import path for TestClient ([#360](https://github.com/sillo-labs/sillo/issues/360))
#### Others

* (release): bump version to 3.11.3
* remove outdated example files ([#359](https://github.com/sillo-labs/sillo/issues/359))

Full set of changes: [`v3.11.2...v3.11.3`](https://github.com/sillo-labs/sillo/compare/v3.11.2...v3.11.3)

## v3.11.2 (2026-04-08)

#### Refactorings

* (handlers): update route parameter handling ([#357](https://github.com/sillo-labs/sillo/issues/357))
#### Docs

* (mounting): deprecate register ([#358](https://github.com/sillo-labs/sillo/issues/358))
* remove old sillo framework references and clean up ([#356](https://github.com/sillo-labs/sillo/issues/356))
#### Others

* bump version to 3.11.2

Full set of changes: [`v3.11.1...v3.11.2`](https://github.com/sillo-labs/sillo/compare/v3.11.1...v3.11.2)

## v3.11.1 (2026-04-07)

#### Refactorings

* (auth): remove support for www-authenticate headers ([#354](https://github.com/sillo-labs/sillo/issues/354))
* (cli): remove custom command functionality and update configuration options ([#352](https://github.com/sillo-labs/sillo/issues/352))
#### Others

* bump version to 3.11.1
* (deps): bump anyio from 4.12.1 to 4.13.0 ([#353](https://github.com/sillo-labs/sillo/issues/353))
* (docs): update release notes ([#355](https://github.com/sillo-labs/sillo/issues/355))

Full set of changes: [`v3.11.0...v3.11.1`](https://github.com/sillo-labs/sillo/compare/v3.11.0...v3.11.1)

## v3.11.0 (2026-04-05)

#### New Features

* (routing): add custom route class support ([#348](https://github.com/sillo-labs/sillo/issues/348))
#### Fixes

* fix types and implement  ty ([#349](https://github.com/sillo-labs/sillo/issues/349))
#### Refactorings

* (dependencies): rewrite di system to improve performance ([#351](https://github.com/sillo-labs/sillo/issues/351))
* remove deprecated get_application function  ([#350](https://github.com/sillo-labs/sillo/issues/350))
#### Others

* bump version to 3.11.0

Full set of changes: [`v3.10.6...v3.11.0`](https://github.com/sillo-labs/sillo/compare/v3.10.6...v3.11.0)

## v3.10.6 (2026-04-01)

#### Docs

* (redis): fix contrib docs to match v0.4.2 ([#347](https://github.com/sillo-labs/sillo/issues/347))
* fix issues with docs ([#346](https://github.com/sillo-labs/sillo/issues/346))
#### Others

* bump version to 3.10.6

Full set of changes: [`v3.10.5...v3.10.6`](https://github.com/sillo-labs/sillo/compare/v3.10.5...v3.10.6)

## v3.10.5 (2026-03-30)

#### Docs

* (changelog): update changelog ([#344](https://github.com/sillo-labs/sillo/issues/344))
#### Others

* bump version to 3.10.5

Full set of changes: [`v3.10.4...v3.10.5`](https://github.com/sillo-labs/sillo/compare/v3.10.4...v3.10.5)

## v3.10.4 (2026-03-27)

#### Fixes

* (templating): inject request context into Jinja2 templates automatically ([#340](https://github.com/sillo-labs/sillo/issues/340))
#### Docs

* (mail): expand email integration examples and usage ([#341](https://github.com/sillo-labs/sillo/issues/341))
#### Others

* bump version to 3.10.4

Full set of changes: [`v3.10.3...v3.10.4`](https://github.com/sillo-labs/sillo/compare/v3.10.3...v3.10.4)

## v3.10.3 (2026-03-26)

#### Fixes

* (session): remove  parameter overwrite in load_session_from_cookie ([#339](https://github.com/sillo-labs/sillo/issues/339))
#### Performance improvements

* (http): optimize import statements and code structure ([#337](https://github.com/sillo-labs/sillo/issues/337))
#### Others

* bump version to 3.10.3
* (views): add comprehensive test  for APIView  ([#338](https://github.com/sillo-labs/sillo/issues/338))

Full set of changes: [`v3.10.2...v3.10.3`](https://github.com/sillo-labs/sillo/compare/v3.10.2...v3.10.3)

## v3.10.2 (2026-03-25)

#### Refactorings

* (http): improve json parsing and form handling ([#336](https://github.com/sillo-labs/sillo/issues/336))
* (sillo): wrap route level middleware at init ([#335](https://github.com/sillo-labs/sillo/issues/335))
#### Others

* (release): bump version to 3.10.2

Full set of changes: [`v3.10.1...v3.10.2`](https://github.com/sillo-labs/sillo/compare/v3.10.1...v3.10.2)

## v3.10.1 (2026-03-24)

#### Docs

* update middleware docs in docs index ([#334](https://github.com/sillo-labs/sillo/issues/334))
#### Others

* (release): bump version to 3.10.1
* (docs): update release notes ([#333](https://github.com/sillo-labs/sillo/issues/333))

Full set of changes: [`v3.10.0...v3.10.1`](https://github.com/sillo-labs/sillo/compare/v3.10.0...v3.10.1)

## v3.10.0 (2026-03-20)

#### Refactorings

* (routing): remove path params wrapping ([#332](https://github.com/sillo-labs/sillo/issues/332))
#### Others

* bump version to 3.10.0

Full set of changes: [`v3.9.1...v3.10.0`](https://github.com/sillo-labs/sillo/compare/v3.9.1...v3.10.0)

## v3.9.1 (2026-03-19)

#### Fixes

* (auth): fix scope validation fixes [#328](https://github.com/sillo-labs/sillo/issues/328) ([#330](https://github.com/sillo-labs/sillo/issues/330))
#### Refactorings

* (routing): update router typpes and defaults ([#329](https://github.com/sillo-labs/sillo/issues/329))
* (response): update docs on sending responses ([#327](https://github.com/sillo-labs/sillo/issues/327))
#### Others

* (release): bump version to 3.9.1

Full set of changes: [`v3.9.0...v3.9.1`](https://github.com/sillo-labs/sillo/compare/v3.9.0...v3.9.1)

## v3.9.0 (2026-03-15)

#### Fixes

* (sillo): handle streaming responses and bytes in ASGI request-response bridge ([#326](https://github.com/sillo-labs/sillo/issues/326))
#### Refactorings

* (response): improve header management and middleware processing   ([#322](https://github.com/sillo-labs/sillo/issues/322))
#### Docs

* (middleware): add return value warnings and examples ([#325](https://github.com/sillo-labs/sillo/issues/325))
* (tasks): update integration docs ([#324](https://github.com/sillo-labs/sillo/issues/324))
#### Others

* bump version to 3.9.0
* update project description in pyproject.toml
* reroginze code structure ([#323](https://github.com/sillo-labs/sillo/issues/323))

Full set of changes: [`v3.8.3...v3.9.0`](https://github.com/sillo-labs/sillo/compare/v3.8.3...v3.9.0)

## v3.8.3 (2026-03-04)

#### Refactorings

* (middleware): update tests for changes at ([#317](https://github.com/sillo-labs/sillo/issues/317)) ([#318](https://github.com/sillo-labs/sillo/issues/318))
* move config handling from MakeConfig to Middleware class ([#317](https://github.com/sillo-labs/sillo/issues/317))
#### Docs

* (sessions): fix session interface typo ([#321](https://github.com/sillo-labs/sillo/issues/321))
* (middleware): update CORS, CSRF, and Session guides ([#320](https://github.com/sillo-labs/sillo/issues/320))
* remove unnecessary emojis ([#319](https://github.com/sillo-labs/sillo/issues/319))
* update contribution guidelines and documentation structure ([#316](https://github.com/sillo-labs/sillo/issues/316))
#### Others

* (release): bump version to 3.8.3

Full set of changes: [`v3.8.2...v3.8.3`](https://github.com/sillo-labs/sillo/compare/v3.8.2...v3.8.3)

## v3.8.2 (2026-02-28)

#### New Features

* (docs): implement rotating banner system ([#312](https://github.com/sillo-labs/sillo/issues/312))
#### Fixes

* (docs): update release notes ([#313](https://github.com/sillo-labs/sillo/issues/313))
#### Docs

* (concurrency): add AsyncEvent documentation and examples   ([#315](https://github.com/sillo-labs/sillo/issues/315))
* add email sending features with sillo-contrib/mail ([#311](https://github.com/sillo-labs/sillo/issues/311))
#### Others

* bump version to 3.8.2
* remove granian dependency from all target ([#314](https://github.com/sillo-labs/sillo/issues/314))

Full set of changes: [`v3.8.1...v3.8.2`](https://github.com/sillo-labs/sillo/compare/v3.8.1...v3.8.2)

## v3.8.1 (2026-02-20)

#### New Features

* (docs): update banner content to promote docs summary ([#309](https://github.com/sillo-labs/sillo/issues/309))
#### Refactorings

* (testing): replace Client with TestClient and improve test setup  ([#310](https://github.com/sillo-labs/sillo/issues/310))
#### Others

* (release): bump version to 3.8.1

Full set of changes: [`v3.8.0...v3.8.1`](https://github.com/sillo-labs/sillo/compare/v3.8.0...v3.8.1)

## v3.8.0 (2026-02-15)

#### Refactorings

* update middleware initialization across multiple tests ([#308](https://github.com/sillo-labs/sillo/issues/308))
* Add `config` parameter to middleware constructors ([#307](https://github.com/sillo-labs/sillo/issues/307))
#### Docs

* (session): update session configuration guide
* (cors): update sillo CORS documentation with new configuration examples
* (middleware): update timeout middleware documentation ([#306](https://github.com/sillo-labs/sillo/issues/306))
#### Others

* bump version to 3.8.0

Full set of changes: [`v3.7.4...v3.8.0`](https://github.com/sillo-labs/sillo/compare/v3.7.4...v3.8.0)

## v3.7.4 (2026-02-04)

#### Docs

* (websockets): fix typos and update websocket examples ([#305](https://github.com/sillo-labs/sillo/issues/305))
* update documentation for routing and websockets ([#304](https://github.com/sillo-labs/sillo/issues/304))
#### Others

* bump version to 3.7.4

Full set of changes: [`v3.7.3...v3.7.4`](https://github.com/sillo-labs/sillo/compare/v3.7.3...v3.7.4)

## v3.7.3 (2026-02-02)

#### Refactorings

* (websockets): remove websocket middleware support ([#303](https://github.com/sillo-labs/sillo/issues/303))
* (Examples): add proper type hints and proper  external integration  ([#301](https://github.com/sillo-labs/sillo/issues/301))
#### Others

* bump version to 3.7.3
* apply code formatting and minor refactors ([#302](https://github.com/sillo-labs/sillo/issues/302))

Full set of changes: [`v3.7.2...v3.7.3`](https://github.com/sillo-labs/sillo/compare/v3.7.2...v3.7.3)

## v3.7.2 (2026-01-26)

#### Fixes

* (websockets): allow empty expire time for channel creation ([#298](https://github.com/sillo-labs/sillo/issues/298))
#### Others

* bump version to 3.7.2

Full set of changes: [`v3.7.1...v3.7.2`](https://github.com/sillo-labs/sillo/compare/v3.7.1...v3.7.2)

## v3.7.1 (2026-01-24)

#### New Features

* add default user model authentication middleware ([#292](https://github.com/sillo-labs/sillo/issues/292))
#### Refactorings

* restructure configuration on middleware  ([#293](https://github.com/sillo-labs/sillo/issues/293))
#### Docs

* (README): compress logo ([#294](https://github.com/sillo-labs/sillo/issues/294))
#### Others

* bump version to 3.7.1

Full set of changes: [`v3.7.0...v3.7.1`](https://github.com/sillo-labs/sillo/compare/v3.7.0...v3.7.1)

## v3.7.0 (2026-01-19)

#### Fixes

* Added Exception and formatted the code  ([#288](https://github.com/sillo-labs/sillo/issues/288))
* correct the indentation in the code snippet ([#286](https://github.com/sillo-labs/sillo/issues/286))
#### Refactorings

* (cli):  drop suppport for `sillo.config.py` ([#290](https://github.com/sillo-labs/sillo/issues/290))
* remove unused sillo config integration
#### Docs

* fix typos and normalize changelog formatting ([#289](https://github.com/sillo-labs/sillo/issues/289))
#### Others

* bump version to 3.7.0
* (v2): depricate sillo v2 ([#291](https://github.com/sillo-labs/sillo/issues/291))

Full set of changes: [`v3.6.3...v3.7.0`](https://github.com/sillo-labs/sillo/compare/v3.6.3...v3.7.0)

## v3.6.3 (2026-01-12)

#### Refactorings

* (routing): replace AsyncEventEmitter with EventEmitter ([#285](https://github.com/sillo-labs/sillo/issues/285))
#### Docs

* (tasks): update task docs and deprecation notice ([#284](https://github.com/sillo-labs/sillo/issues/284))
* (events): update and clarify event system documentation ([#281](https://github.com/sillo-labs/sillo/issues/281))
#### Others

* bump version to 3.6.3
* (deps): bump anyio from 4.12.0 to 4.12.1 ([#279](https://github.com/sillo-labs/sillo/issues/279))
* (events): depricate async event emitter

Full set of changes: [`v3.6.2...v3.6.3`](https://github.com/sillo-labs/sillo/compare/v3.6.2...v3.6.3)

## v3.6.2 (2026-01-08)

#### New Features

* (file): add save method to handle file saving ([#278](https://github.com/sillo-labs/sillo/issues/278))
#### Refactorings

* (internals): organize core data structures ([#277](https://github.com/sillo-labs/sillo/issues/277))
#### Others

* bump version to 3.6.2
* (deps): bump anyio from 4.11.0 to 4.12.0 ([#249](https://github.com/sillo-labs/sillo/issues/249))

Full set of changes: [`v3.6.1...v3.6.2`](https://github.com/sillo-labs/sillo/compare/v3.6.1...v3.6.2)

## v3.6.1 (2026-01-05)

#### New Features

* (docs): add announcement banner component ([#276](https://github.com/sillo-labs/sillo/issues/276))
#### Docs

* (configuration): add warning about global configuration in tests ([#273](https://github.com/sillo-labs/sillo/issues/273))
#### Others

* bump version to 3.6.1

Full set of changes: [`v3.6.0...v3.6.1`](https://github.com/sillo-labs/sillo/compare/v3.6.0...v3.6.1)

## v3.6.0 (2026-01-01)

#### New Features

* (docs): add comment section using Giscus ([#268](https://github.com/sillo-labs/sillo/issues/268))
#### Refactorings

* (config): replace nested config dict with typed classes ([#270](https://github.com/sillo-labs/sillo/issues/270))
#### Docs

* update CORS and session config docs ([#272](https://github.com/sillo-labs/sillo/issues/272))
* update logo image ([#269](https://github.com/sillo-labs/sillo/issues/269))
* update API reference links and remove unused references ([#265](https://github.com/sillo-labs/sillo/issues/265))
* (changelog): update changelog with recent releases ([#264](https://github.com/sillo-labs/sillo/issues/264))
#### Others

* bump version to 3.6.0

Full set of changes: [`v3.5.0...v3.6.0`](https://github.com/sillo-labs/sillo/compare/v3.5.0...v3.6.0)

## v3.5.0 (2025-12-18)

#### Fixes

* (openapi): improve Schema model validation ([#262](https://github.com/sillo-labs/sillo/issues/262))
#### Refactorings

* (openapi): improve schema handling and nesting ([#260](https://github.com/sillo-labs/sillo/issues/260))

Full set of changes: [`v3.4.2...v3.5.0`](https://github.com/sillo-labs/sillo/compare/v3.4.2...v3.5.0)

## v3.4.2 (2025-12-11)

#### New Features

* (auth):  improve error handling ([#253](https://github.com/sillo-labs/sillo/issues/253))
#### Refactorings

* (config): remove unused type definitions and classes ([#254](https://github.com/sillo-labs/sillo/issues/254))
* (config): remove default config and improve error handling ([#254](https://github.com/sillo-labs/sillo/issues/254))
* fallback to singleton with validation from request.state ([#252](https://github.com/sillo-labs/sillo/issues/252))

Full set of changes: [`v3.3.2...v3.4.2`](https://github.com/sillo-labs/sillo/compare/v3.3.2...v3.4.2)

## v3.3.2 (2025-11-27)

#### New Features

* (openapi): add termsOfService field to Info model ([#244](https://github.com/sillo-labs/sillo/issues/244))
* (docs): add Tortoise ORM integration to community extensions ([#243](https://github.com/sillo-labs/sillo/issues/243))
#### Refactorings

* remove unused route path getter and simplify handler type ([#247](https://github.com/sillo-labs/sillo/issues/247))
#### Docs

* add create_background_task to docs ([#245](https://github.com/sillo-labs/sillo/issues/245))
* migrate changelog to auto-changelog format ([#242](https://github.com/sillo-labs/sillo/issues/242))
#### Others

* (release): bump version to 3.3.2

Full set of changes: [`v3.3.1...v3.3.2`](https://github.com/sillo-labs/sillo/compare/v3.3.1...v3.3.2)

## v3.3.1 (2025-11-19)

#### Fixes

* fix inconsistencies around concurrency docs  ([#240](https://github.com/sillo-labs/sillo/issues/240))
* correct Angular commit message format
#### Refactorings

* drop support for multiple server or else when set by user ([#239](https://github.com/sillo-labs/sillo/issues/239))
#### Docs

* update sitemap.xml for silloLabs website ([#236](https://github.com/sillo-labs/sillo/issues/236))
* (docs): update navbar links and add blog link ([#235](https://github.com/sillo-labs/sillo/issues/235))
* rename readme.md to README.md
* remove readme.md
* (readme): remove community-driven description from sillo definition
* update documentation URL and related links
* refactor and reorganise  sillo vitepress docs ([#233](https://github.com/sillo-labs/sillo/issues/233))
* add comprehensive doc for core component ([#232](https://github.com/sillo-labs/sillo/issues/232))
* add comprehensive doc for core components  ([#231](https://github.com/sillo-labs/sillo/issues/231))
* (readme): update import paths for middleware ([#230](https://github.com/sillo-labs/sillo/issues/230))
#### Others

* bump version to 3.3.1 ([#241](https://github.com/sillo-labs/sillo/issues/241))
*  make few changes to sillo build ([#237](https://github.com/sillo-labs/sillo/issues/237))
* (pyproject): normalize readme filename reference ([#234](https://github.com/sillo-labs/sillo/issues/234))

Full set of changes: [`v3.3.0...v3.3.1`](https://github.com/sillo-labs/sillo/compare/v3.3.0...v3.3.1)
...
* (routing): remove deprecated WSRouter ([#228](https://github.com/sillo-labs/sillo/issues/228))
* (websockets): unify HTTP and WebSocket routing
* (sillo): merge WSRouter into Router for unified routing
* (routing): improve route matching and method handling
* (routing): update route matching to use scope object
#### Docs

* Simplify silloApp initialization ([#205](https://github.com/sillo-labs/sillo/issues/205))
* remove duplicate FAQ entries and update content ([#221](https://github.com/sillo-labs/sillo/issues/221))
* update API reference and versioning ([#220](https://github.com/sillo-labs/sillo/issues/220))
#### Others
...
Full set of changes: [`v3.2.1...v3.3.0`](https://github.com/sillo-labs/sillo/compare/v3.2.1...v3.3.0)

## v3.2.1 (2025-11-07)

#### Refactorings

* replace generic Parameter with specific types ([#216](https://github.com/sillo-labs/sillo/issues/216))
#### Docs
...
Full set of changes: [`v3.2.0...v3.2.1`](https://github.com/sillo-labs/sillo/compare/v3.2.0...v3.2.1)
...
* (openapi): remove APIDocumentation singleton and unused imports ([#211](https://github.com/sillo-labs/sillo/issues/211))
* (openapi): remove APIDocumentation instantiation from silloApp
* (openapi): move get_openapi function to APIDocumentation class
* restructure routing and grouping ([#210](https://github.com/sillo-labs/sillo/issues/210))
#### Docs

* expand OpenAPI  documentation ([#214](https://github.com/sillo-labs/sillo/issues/214))
* improve jrpc and tasks documentation ([#209](https://github.com/sillo-labs/sillo/issues/209))
* (changelog): update CHANGELOG.md for v3.1.0 release
#### Others

* bump version from 3.1.0 to 3.2.0

Full set of changes: [`v3.1.0...v3.2.0`](https://github.com/sillo-labs/sillo/compare/v3.1.0...v3.2.0)

## v3.1.0 (2025-11-03)

#### Fixes

* (auth): improve scope checking in auth decorator  ([#205](https://github.com/sillo-labs/sillo/issues/205))
* (auth): improve scope checking in auth decorator ([#205](https://github.com/sillo-labs/sillo/issues/205))
* (response): return streamed response in call_next manager
#### Docs

* rewrite README for  utility-first framework ([#207](https://github.com/sillo-labs/sillo/issues/207))
#### Others

* bump version to 3.1.0

Full set of changes: [`v3.0.0...v3.1.0`](https://github.com/sillo-labs/sillo/compare/v3.0.0...v3.1.0)
...
* (response):  return the streamed response instead of sillo response manager for the call_next function manager
...
* (sillo): improve type annotations and remove unused imports
* add type: ignore comments to suppress mypy errors
* (sillo): remove file router and apply static typing
...
* (community): expand documentation for sillo-contrib and open source FAQ
* update CHANGELOG.md with recent fixes
* (readme): update package version in installation instructions
* (readme): update sillo version and remove v3 warning
...
* (events): add tests for sillo event system
...
Full set of changes: [`v2.11.13...v3.0.0`](https://github.com/sillo-labs/sillo/compare/v2.11.13...v3.0.0)
...
Full set of changes: [`v2.11.12...v2.11.13`](https://github.com/sillo-labs/sillo/compare/v2.11.12...v2.11.13)
...
Full set of changes: [`v2.11.11...v2.11.12`](https://github.com/sillo-labs/sillo/compare/v2.11.11...v2.11.12)
...
* (exception_handler): optimize exception handling and middleware initialization ([#194](https://github.com/sillo-labs/sillo/issues/194))
* (exception_handler): optimize exception handling and middleware initialization
* (openapi): move OpenAPI documentation setup to routing  ([#192](https://github.com/sillo-labs/sillo/issues/192))
...
* add sillo CLI and framework details to documentation
* (readme): remove incorrect information about Rust engine
#### Others

* (readme): fix star message formatting

Full set of changes: [`v2.11.10...v2.11.11`](https://github.com/sillo-labs/sillo/compare/v2.11.10...v2.11.11)
...
Full set of changes: [`v2.11.9...v2.11.10`](https://github.com/sillo-labs/sillo/compare/v2.11.9...v2.11.10)
...
Full set of changes: [`v2.11.8...v2.11.9`](https://github.com/sillo-labs/sillo/compare/v2.11.8...v2.11.9)
...
Full set of changes: [`v2.11.7...v2.11.8`](https://github.com/sillo-labs/sillo/compare/v2.11.7...v2.11.8)
...
Full set of changes: [`v2.11.6...v2.11.7`](https://github.com/sillo-labs/sillo/compare/v2.11.6...v2.11.7)
...
Full set of changes: [`v2.11.5...v2.11.6`](https://github.com/sillo-labs/sillo/compare/v2.11.5...v2.11.6)
...
Full set of changes: [`v2.11.4...v2.11.5`](https://github.com/sillo-labs/sillo/compare/v2.11.4...v2.11.5)
...
Full set of changes: [`v2.11.3...v2.11.4`](https://github.com/sillo-labs/sillo/compare/v2.11.3...v2.11.4)
...
Full set of changes: [`v2.11.2...v2.11.3`](https://github.com/sillo-labs/sillo/compare/v2.11.2...v2.11.3)
...
* (sillo): add request_content_type parameter for OpenAPI documentation
#### Fixes

* (http): remove debug prints and improve UploadedFile class
#### Refactorings

* (sillo): update UploadedFile for Pydantic 2 compatibility
...
Full set of changes: [`v2.11.1...v2.11.2`](https://github.com/sillo-labs/sillo/compare/v2.11.1...v2.11.2)
...
* (readme): update sillo version to 2.11.x
...
Full set of changes: [`v2.11.0...v2.11.1`](https://github.com/sillo-labs/sillo/compare/v2.11.0...v2.11.1)
...
* (sillo): make code more concise and remove unused imports
...
* (api): remove redundant openapi_config from silloApp example
* update response header method in routing guide
* (team): update Mohammed Al-Ameen's description
#### Others

* (docs): update dependency cache
* (deps): update sillo to v2.10.3

Full set of changes: [`v2.10.3...v2.11.0`](https://github.com/sillo-labs/sillo/compare/v2.10.3...v2.11.0)
...
Full set of changes: [`v2.10.2...v2.10.3`](https://github.com/sillo-labs/sillo/compare/v2.10.2...v2.10.3)
...
* (benchmarks): update sillo version and lock file

Full set of changes: [`v2.10.1...v2.10.2`](https://github.com/sillo-labs/sillo/compare/v2.10.1...v2.10.2)
...
Full set of changes: [`v2.10.0...v2.10.1`](https://github.com/sillo-labs/sillo/compare/v2.10.0...v2.10.1)
...
Full set of changes: [`v2.9.3...v2.10.0`](https://github.com/sillo-labs/sillo/compare/v2.9.3...v2.10.0)
...
Full set of changes: [`v2.9.2...v2.9.3`](https://github.com/sillo-labs/sillo/compare/v2.9.2...v2.9.3)
...
* add csrf to docs ([#169](https://github.com/sillo-labs/sillo/issues/169))

Full set of changes: [`v2.9.1...v2.9.2`](https://github.com/sillo-labs/sillo/compare/v2.9.1...v2.9.2)
...
* update README for sillo version 2.9.x and clean up formatting
#### Others

* clean up CHANGELOG by removing outdated entries and fixing formatting issues

Full set of changes: [`v2.9.0...v2.9.1`](https://github.com/sillo-labs/sillo/compare/v2.9.0...v2.9.1)
...
Full set of changes: [`v2.8.6...v2.9.0`](https://github.com/sillo-labs/sillo/compare/v2.8.6...v2.9.0)
...
Full set of changes: [`v2.8.5...v2.8.6`](https://github.com/sillo-labs/sillo/compare/v2.8.5...v2.8.6)
...
Full set of changes: [`v2.8.4...v2.8.5`](https://github.com/sillo-labs/sillo/compare/v2.8.4...v2.8.5)
...
Full set of changes: [`v2.8.3...v2.8.4`](https://github.com/sillo-labs/sillo/compare/v2.8.3...v2.8.4)
...
Full set of changes: [`v2.8.2...v2.8.3`](https://github.com/sillo-labs/sillo/compare/v2.8.2...v2.8.3)
...
Full set of changes: [`v2.8.0...v2.8.2`](https://github.com/sillo-labs/sillo/compare/v2.8.0...v2.8.2)
...
Full set of changes: [`v2.7.0...v2.8.0`](https://github.com/sillo-labs/sillo/compare/v2.7.0...v2.8.0)
...
Full set of changes: [`v2.6.2...v2.7.0`](https://github.com/sillo-labs/sillo/compare/v2.6.2...v2.7.0)
...
* remove CHANGELOG.md and sillo.config.py files to streamline project structure and eliminate unused configurations
...
Full set of changes: [`v2.6.1...v2.6.2`](https://github.com/sillo-labs/sillo/compare/v2.6.1...v2.6.2)

## v2.6.1 (2025-07-03)

#### New Features

* enhance sillo CLI commands to support optional configuration loading, improve error handling, and update command help descriptions for clarity
...
* implement configuration file support for sillo CLI, allowing app and server options to be defined in `sillo.config.py`, and enhance command functionality to load configurations seamlessly
...
* enhance app loading by adding auto-search for sillo.config.py and .sillocli files in the current directory
* add CLI commands to list registered URLs and ping routes in the sillo application, with support for loading app instances from module paths or config files
#### Refactorings
...
* update configuration documentation to highlight new CLI support for `sillo.config.py`, including usage tips and best practices for managing app and server options
* update CLI guide to reflect new configuration structure in `sillo.config.py`, streamline examples for development and production setups, and enhance clarity on command usage and supported variables
...
* remove deprecated `sillo.config.py` file as configuration support has been streamlined and integrated into the CLI
* update changelog for version 2.6.0, including release notes and version bump in README

Full set of changes: [`v2.6.0...v2.6.1`](https://github.com/sillo-labs/sillo/compare/v2.6.0...v2.6.1)
...
Full set of changes: [`v2.5.3...v2.6.0`](https://github.com/sillo-labs/sillo/compare/v2.5.3...v2.6.0)
...
* update Day 1 and Day 2 course materials to enhance clarity and structure, including improved explanations of sillo features, routing concepts, and practical examples for building applications
* expand middleware and response handling sections in the guide to clarify usage of sillo-specific and ASGI middleware, and enhance response object documentation with examples for various response types and customization options
#### Others
...
Full set of changes: [`v2.5.2...v2.5.3`](https://github.com/sillo-labs/sillo/compare/v2.5.2...v2.5.3)

## v2.5.2 (2025-06-29)

#### New Features

* enhance silloApp.run method to support Granian server
#### Fixes
...
* remove duplicate import of silloApp in day22 index documentation
#### Refactorings
...
* update link to Examples section in the sillo guide for better navigation
#### Others
...
Full set of changes: [`v2.5.1...v2.5.2`](https://github.com/sillo-labs/sillo/compare/v2.5.1...v2.5.2)
...
Full set of changes: [`v2.5.0...v2.5.1`](https://github.com/sillo-labs/sillo/compare/v2.5.0...v2.5.1)
...
Full set of changes: [`v2.4.14...v2.5.0`](https://github.com/sillo-labs/sillo/compare/v2.4.14...v2.5.0)

## v2.4.14 (2025-06-20)

#### Fixes

* handle directory initialization and path formatting in StaticFiles class for improved file serving, closes [#136](https://github.com/sillo-labs/sillo/issues/136)
#### Docs
...
Full set of changes: [`v2.4.13...v2.4.14`](https://github.com/sillo-labs/sillo/compare/v2.4.13...v2.4.14)
...
Full set of changes: [`v2.4.12...v2.4.13`](https://github.com/sillo-labs/sillo/compare/v2.4.12...v2.4.13)
...
Full set of changes: [`v2.4.11...v2.4.12`](https://github.com/sillo-labs/sillo/compare/v2.4.11...v2.4.12)
...
Full set of changes: [`v2.4.10...v2.4.11`](https://github.com/sillo-labs/sillo/compare/v2.4.10...v2.4.11)
...
* expand Day 5 content on middleware in sillo, introducing function-based and class-based middleware, built-in middleware examples, and best practices for implementation
...
* develop a production-ready real-time collaboration platform using sillo, featuring authentication, WebSocket communication, API endpoints, and comprehensive monitoring and error handling
* implement a real-time chat application using sillo WebSockets, featuring channel management, message history, presence tracking, and private messaging capabilities
...
Full set of changes: [`v2.4.9...v2.4.10`](https://github.com/sillo-labs/sillo/compare/v2.4.9...v2.4.10)
...
Full set of changes: [`v2.4.8...v2.4.9`](https://github.com/sillo-labs/sillo/compare/v2.4.8...v2.4.9)
...
* enhance core concepts and getting started guide for sillo with detailed examples and improved structure
...
Full set of changes: [`v2.4.7...v2.4.8`](https://github.com/sillo-labs/sillo/compare/v2.4.7...v2.4.8)
...
Full set of changes: [`v2.4.6...v2.4.7`](https://github.com/sillo-labs/sillo/compare/v2.4.6...v2.4.7)
...
Full set of changes: [`v2.4.5...v2.4.6`](https://github.com/sillo-labs/sillo/compare/v2.4.5...v2.4.6)
...
Full set of changes: [`v2.4.4...v2.4.5`](https://github.com/sillo-labs/sillo/compare/v2.4.4...v2.4.5)
...
* Add Groups section and examples to routers-and-subapps guide; fix silloApp instantiation in index
#### Others
...
Full set of changes: [`v2.4.3...v2.4.4`](https://github.com/sillo-labs/sillo/compare/v2.4.3...v2.4.4)
...
Full set of changes: [`v2.4.2...v2.4.3`](https://github.com/sillo-labs/sillo/compare/v2.4.2...v2.4.3)
...
* replace get_application with silloApp and add startup/shutdown hooks
#### Others
...
Full set of changes: [`v2.4.1...v2.4.2`](https://github.com/sillo-labs/sillo/compare/v2.4.1...v2.4.2)
...
Full set of changes: [`v2.4.0...v2.4.1`](https://github.com/sillo-labs/sillo/compare/v2.4.0...v2.4.1)
...
* (docs): add comprehensive documentation and configuration for sillo framework
...
* Add comprehensive overview of sillo framework in about.md
* Update SUMMARY.md to include comprehensive Dependency Injection section
* Enhance documentation and add dependency injection support in sillo framework
...
* Add multi-server support with Uvicorn and Granian in sillo CLI
* Add example applications and routes for sillo framework
...
* (config): Initialize configuration in silloApp constructor
...
* (minor): Remove unused TypeVar and clean up lifespan handling in silloApp
...
* Enhance lifespan shutdown handling in silloApp
* Simplify lifespan shutdown handling in silloApp
* Update sillo to use Granian server and enhance configuration options
...
* Enhance documentation for Dependency Injection and sillo framework with examples and architecture overview
#### Others
...
* (docs): Remove About sillo link from SUMMARY.md for improved clarity
* (docs): Update About sillo link format in SUMMARY.md
* (docs): Add About sillo link to SUMMARY.md
...
Full set of changes: [`v2.3.1...v2.4.0`](https://github.com/sillo-labs/sillo/compare/v2.3.1...v2.4.0)

## v2.3.1 (2025-04-14)

#### New Features

* (docs): add comprehensive documentation for sillo configuration and hooks
...
Full set of changes: [`v2.3.0-rc.1...v2.3.1`](https://github.com/sillo-labs/sillo/compare/v2.3.0-rc.1...v2.3.1)
...
* ✨: add content_length property and set_body method in silloResponse; enhance set_headers to support overriding headers in CORS middleware
* 🔧: add lifespan support to silloApp and implement close_all_connections method in ChannelBox
...
* enhance sillo CLI with project initialization and database setup commands
...
* 🔧: remove debug print statement for message in silloApp to clean up output
...
* 🔧: rename __handle_lifespan to handle_lifespan and improve message logging in silloApp
...
* (docs): add sillo Events section to documentation
