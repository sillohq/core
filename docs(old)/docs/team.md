...
const coreTeam = [
  {
    ...
    desc: 'Core architect and maintainer of sillo. Focused on async performance and clean architecture.',
    links: [
...
const maintainers = [
  {
    ...
    desc: 'Creator of the sillo file router system',
    links: [
...
<VPTeamPage>
  <VPTeamPageTitle>
    ...
    <template #lead>
      The development of sillo is guided by an experienced team of developers who are passionate about building fast, clean, and developer-friendly web frameworks. The project thrives thanks to contributions from our amazing community.
    </template>
  </VPTeamPageTitle>

  <VPTeamPageSection>
    <template #title>Core Team</template>
    <template #lead>The core development team behind sillo.</template>
    <template #members>
  ...
  <VPTeamPageSection>
    ...
    <template #lead>Active maintainers helping to ensure sillo's continued development and success.</template>
    <template #members>
