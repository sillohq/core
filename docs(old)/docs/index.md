---
layout: home
title: sillo - Async Python Web Framework
description: Build high-performance async APIs with sillo, a modern Python web framework featuring clean architecture, zero boilerplate, and excellent developer experience.
head:
  - - meta
    - property: og:title
      content: sillo - Async Python Web Framework
  - - meta
    - property: og:description
      content: Build high-performance async APIs with sillo, a modern Python web framework featuring clean architecture, zero boilerplate, and excellent developer experience.
hero:
  name: sillo
  text: Async Python Web Framework 
  tagline: sillo is a fast, minimalist Python framework for building async APIs with clean architecture , zero boilerplate , and a Pythonic feel .
  ...
  actions:
    ...
    - theme: alt
      text:  View on GitHub
      link: https://github.com/sillo-labs/sillo
    - theme: alt
      text:  Why sillo?
      link: /guide/why-sillo
...
features:
  ...
  - icon: 🔨
    ...
    details: |
      ...
      - OpenAPI/Swagger
      - Testing utilities
      - Email sending with sillo-contrib mail
...
**Broadcasta** is a powerful real time messaging and event broadcasting service from sillo Labs.  
...
👉 **[Get started with Broadcasta →](https://bd.sillolabs.com)**
...
Use `sillo run --reload` for automatic reloading during development. 🔄
:::
...
```python [Async Email]
from sillo_contrib.mail import send_email_async
...
```python [With Context]
from sillo.dependecies import Context
...
sillo is built for production use with:
...
sillo comes with a powerful command-line interface that makes development and deployment a breeze. The sillo CLI is your primary tool for managing sillo applications throughout their lifecycle.
...
sillo new my-awesome-app

```


::: danger Important Note
Do not use the sillo CLI if you are new to sillo.
:::

For complete documentation on using the sillo CLI, check out the [CLI Documentation](/guide/cli).

## 🧘 The Zen of sillo

sillo embraces the Zen of Python, particularly the second principle: "Explicit is better than implicit." Here's how:
