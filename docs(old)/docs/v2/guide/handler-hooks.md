---
title: Handler Hooks
description: sillo provides a set of hooks that allow you to execute code at specific points in the request-response cycle. These hooks can be used to perform tasks such as authentication, logging, and error handling.
head:
  - - meta
    - property: og:title
  ...
  - - meta
    - property: og:description
      content: sillo provides a set of hooks that allow you to execute code at specific points in the request-response cycle. These hooks can be used to perform tasks such as authentication, logging, and error handling.
---
# Handler Hooks `deprecated`

::: danger
`sillo.hooks` is not available in the current codebase. Use middleware instead.
:::
