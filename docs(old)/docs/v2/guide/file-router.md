---
title: sillo File Router Guide
description: sillo provides a powerful file router system that makes it easy to develop, test, and deploy your applications. This guide will walk you through using the file router system, starting with basic commands and gradually introducing the configuration system.
head:
  - - meta
    - property: og:title
      content: sillo File Router Guide
  - - meta
    - property: og:description
      content: sillo provides a powerful file router system that makes it easy to develop, test, and deploy your applications. This guide will walk you through using the file router system, starting with basic commands and gradually introducing the configuration system.
---
...
# sillo File Router System: Complete Guide
...
from sillo.file_router import FileRouter
...
```python
from sillo.file_router.utils import mark_as_route
...
```python
from sillo.file_router.html import configure_templates
...
```python
from sillo.file_router.html import render
...
This guide provides a comprehensive overview of sillo's file routing system with clear hierarchical organization and practical examples. The dynamic parameter notation has been updated to use `{param_name}` consistently throughout.