---
title: Pagination
description: sillo provides a flexible and customizable pagination system that makes managing large datasets a breeze. With support for dynamic page sizes, custom query parameters, and seamless API integration, you can create efficient, user-friendly paginated experiences with minimal code.
head:
  - - meta
    - property: og:title
      content: Pagination
  - - meta
    - property: og:description
      content: sillo provides a flexible and customizable pagination system that makes managing large datasets a breeze. With support for dynamic page sizes, custom query parameters, and seamless API integration, you can create efficient, user-friendly paginated experiences with minimal code.
---
## Simple Pagination
...
```python
from sillo.pagination import PaginationStrategy
...
While sillo provides a convenient way to use pagination, you can also manually integrate pagination into your app.

```python
from sillo import silloApp
fromsillo.pagination import SyncListDataHandler, PageNumberPagination, SyncPaginator
app = silloApp()
