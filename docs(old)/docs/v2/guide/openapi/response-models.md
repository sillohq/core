...
Response models describe the structure and content of the data your API returns. sillo leverages Pydantic models for response validation and OpenAPI documentation, ensuring your API is both robust and clearly documented.
...
By default, sillo documents a 200 response using the model you specify in the `responses` argument.
...
For advanced response customization (headers, examples, etc.), see the OpenAPI specification or sillo advanced guides.
