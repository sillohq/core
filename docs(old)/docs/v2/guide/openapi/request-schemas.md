# Request Models in sillo

Request models are the backbone of robust, secure, and well-documented APIs. In sillo, request models are built using Pydantic's `BaseModel`, which provides automatic validation, serialization, and OpenAPI integration.
