# Documenting Request Parameters in sillo

Request parameters are essential for making your API flexible, filterable, and powerful. sillo supports three main types of request parameters: path parameters, query parameters, and headers. This guide explains how to document each type in your OpenAPI docs, with clear examples and best practices.

---

## Path Parameters

Path parameters are part of the URL and are used to identify specific resources. sillo automatically detects and documents path parameters in your routes.
...
Query parameters are used for filtering, sorting, or pagination. sillo does not auto-detect query parameters, but you can explicitly document them using the `parameters` argument.
...
For more advanced parameter types (enums, arrays, etc.), see the OpenAPI specification or the sillo advanced guides.
