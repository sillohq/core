---
title: Static Files
description: Serving static files is a common requirement for web applications. sillo provides a robust and flexible system for serving static assets like CSS, JavaScript, images, and other file types with security and performance in mind.
head:
  - - meta
    - property: og:title
  ...
  - - meta
    - property: og:description
      content: Serving static files is a common requirement for web applications. sillo provides a robust and flexible system for serving static assets like CSS, JavaScript, images, and other file types with security and performance in mind.
---

# Static Files

Serving static files is a common requirement for web applications. sillo provides a robust and flexible system for serving static assets like CSS, JavaScript, images, and other file types with security and performance in mind.
...
To serve static files in sillo, you can use either the new `StaticFiles` class or the deprecated `StaticFilesHandler`:
...
```python
from sillo import silloApp
from sillo.static import StaticFilesHandler
...
When serving from multiple directories, sillo searches for files in the order the directories are specified.
