...
This guide provides canonical, working examples for building APIs with sillo. All code is idiomatic and matches the sillo source, docs, and real-world examples.

::: tip sillo Request API
...
sillo provides convenient properties to quickly detect and handle different types of requests:
...
async def download_file(req, res):
    ...
    from sillo.responses import FileResponse
...
async def login(req, res):
    ...
    if username == "admin" and password == "password":
        ...
        from sillo.auth.backends.session import login
        login(req, user)
...
For more, see the official sillo documentation and the `examples/` folder in the repo. 
