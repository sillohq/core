...
A lightweight, production‑ready request ID middleware for the sillo ASGI framework.
...
import sillo_contrib.request_id as request_id
...
```python
from sillo_contrib.request_id import (
    generate_request_id,
...
async def get_users(request, response):
    ...
    from sillo_contrib.request_id import get_request_id_from_request
...
```python
from sillo_contrib.request_id import RequestIdMiddleware
