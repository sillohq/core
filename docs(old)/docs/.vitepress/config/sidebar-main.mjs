...
export const sidebarCommunity = [
  ...
  { text: 'Discussions', link: 'https://github.com/orgs/sillo-labs/discussions' },
  { text: 'Team', link: '/team' },
]

export const sidebarApiReference = [
  { text: 'Overview', link: '/api-reference' },
  { text: 'sillo App', link: '/api-reference/sillo-app' },
...
export const sidebarGuide = [
  ...
  { text: "Why sillo?", link: '/guide/why-sillo' },
  {
    text: 'Core Concepts',
    collapsed: false,
    items: [
