---
title: WebSocket Consumers in sillo
description: sillo provides a powerful `WebSocketConsumer` class that simplifies building robust WebSocket endpoints. This class-based approach offers structure, reusability, and built-in channel management for your real-time applications.
head:
  - - meta
    - property: og:title
      content: WebSocket Consumers in sillo
  - - meta
    - property: og:description
      content: sillo provides a powerful `WebSocketConsumer` class that simplifies building robust WebSocket endpoints. This class-based approach offers structure, reusability, and built-in channel management for your real-time applications.
---

#  WebSocket Consumers in sillo

sillo provides a powerful `WebSocketConsumer` class that simplifies building robust WebSocket endpoints. This class-based approach offers structure, reusability, and built-in channel management for your real-time applications.
...
```python
from sillo.websockets.consumers import WebSocketConsumer
