---
title: Why sillo?
description: sillo is a modern, async-first Python web framework designed with performance, developer experience, and clean architecture in mind. Here's why you might want to choose sillo for your next project.
head:
  - - meta
    - property: og:title
      content: Why sillo?
  - - meta
    - property: og:description
      content: sillo is a modern, async-first Python web framework designed with performance, developer experience, and clean architecture in mind. Here's why you might want to choose sillo for your next project.
---

#  Why sillo?

sillo is a modern, async-first Python web framework designed with performance, developer experience, and clean architecture in mind. Here's why you might want to choose sillo for your next project.

##  Key Advantages

### 1. True Async Performance

Unlike other frameworks that add async as an afterthought, sillo is built from the ground up with async/await:
- Native ASGI support
...
sillo promotes clean code practices through:
...
sillo provides a modern authentication system:
...
app.add_middleware(
    CORSMiddleware(
        config=CorsConfig(
            debug=True,
            allow_origins=["https://localhost:5000", "https://api.sillo.hub"]
        )
    )
)
```
...
- **Async Design**: While both are async, sillo is built async-first without any sync compatibility layers
- **Clean Architecture**: sillo promotes domain-driven design and clean architecture patterns
...
sillo is particularly well-suited for:
...
Ready to try sillo? Check out our [Quick Start Guide](/guide/getting-started) or dive into the [Examples](/api-examples/).

::: tip Community
Join our growing community:
- [GitHub Discussions](https://github.com/sillo-labs/sillo/discussions)
- [Discord Server](https://discord.gg/sillo)
- [Twitter Updates](https://x.com/sillo-labs)
:::

::: warning Python Version
sillo requires Python 3.9 or higher to leverage modern language features.
::: 