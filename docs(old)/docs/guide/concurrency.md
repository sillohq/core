---
title: Concurrency in sillo
description: Learn how to use concurrency utilities in sillo
head:
  - - meta
    - property: og:title
      content: Concurrency in sillo
  - - meta
    - property: og:description
      content: Learn how to use concurrency utilities in sillo
---
#  Concurrency Utilities

sillo provides powerful concurrency utilities to handle common async patterns in web applications. These utilities help you build performant, scalable applications by efficiently managing concurrent operations, parallel processing, and resource utilization.
...
sillo concurrency utilities make these patterns simple and reliable.
...
from sillo.utils.concurrency import TaskGroup
import httpx
...
```python
from sillo.utils.concurrency import run_until_first_complete
import asyncio
...
```python
from sillo.utils.concurrency import create_background_task
import asyncio
...
```python
from sillo.utils.concurrency import AsyncLazy
import pandas as pd
...
```python
from sillo.utils.concurrency import AsyncEvent
import asyncio
...
sillo concurrency utilities provide a robust foundation for building high-performance async applications:
