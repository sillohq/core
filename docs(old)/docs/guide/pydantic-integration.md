...
description: sillo provides seamless integration with Pydantic, offering a flexible way to handle data validation and serialization. Unlike some frameworks that force you to use type hints, sillo gives you the freedom to choose between dynamic typing and strict type validation.
head:
  - - meta
    - property: og:title
  ...
  - - meta
    - property: og:description
      content: sillo provides seamless integration with Pydantic, offering a flexible way to handle data validation and serialization. Unlike some frameworks that force you to use type hints, sillo gives you the freedom to choose between dynamic typing and strict type validation.
---
