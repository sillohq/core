...
The `Route` class represents individual HTTP routes in sillo, providing detailed configuration options for path patterns, HTTP methods, middleware, dependencies, and OpenAPI documentation.
