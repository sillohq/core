...
The `ChannelBox` class is a singleton manager for WebSocket channels in sillo. It provides group-based channel management, allowing you to organize channels into groups and broadcast messages to all channels within a group.
...
**Usage:**
```python
from sillo.websockets.channels import ChannelBox, Channel
