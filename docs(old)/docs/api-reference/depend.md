...
sillo provides a powerful dependency injection system that allows you to manage shared resources, services, and state across your application in a clean and testable way.

##  Depend Class

The `Depend` class is the core component for dependency injection in sillo.
...
```python
from sillo.dependencies import Context, current_context
...
- [Application](./sillo-app.md) - Application-level dependencies