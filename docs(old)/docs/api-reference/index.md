...
Welcome to the comprehensive sillo API reference documentation. This section provides detailed information about all classes, methods, and components in the sillo framework.
...
- **Getting Started**: [Application Setup](./sillo-app.md)
...
### Type Annotations
sillo uses comprehensive type annotations. All parameters and return types are documented.
