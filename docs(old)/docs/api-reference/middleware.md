...
The `BaseMiddleware` class provides the foundation for creating custom middleware in sillo, allowing you to intercept and process HTTP requests and responses.
...
sillo provides several built-in middleware classes:
...
```python
from sillo.middleware import CSRFMiddleware
...
```python
from sillo.middleware import SessionMiddleware
...
- [Application](./sillo-app.md) - Application middleware setup
