...
The `Router` class is the core routing component in sillo, responsible for organizing and managing HTTP routes with support for prefixes, middleware, dependencies, and sub-routers.
