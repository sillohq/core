---
title: Why sillo?
description: sillo is a modern, async-first Python web framework designed with performance, developer experience, and clean architecture in mind. Here's why you might want to choose sillo for your next
  project.
head:
- tag: meta
  attrs:
...
- tag: meta
  attrs:
    ...
    content: sillo is a modern, async-first Python web framework designed with performance, developer experience, and clean architecture in mind. Here's why you might want to choose sillo for your next
      project.
---
