...
icon: template
description: 'This guide covers advanced features and patterns for the sillo templating system.
...
- tag: meta
  attrs:
    ...
    content: This guide covers advanced features and patterns for the sillo templating system.
---
#  Advanced Templating
