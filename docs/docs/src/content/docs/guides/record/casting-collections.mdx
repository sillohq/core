...
- [Models & Mixins](/guides/record/models/): accessors, mutators, and
  serialization
...
- [Pagination](/guides/record/pagination/): bounding result sets before
  collecting them
- [Crypto helpers](/guides/helpers/crypto/): proper symmetric encryption and
  HMAC
