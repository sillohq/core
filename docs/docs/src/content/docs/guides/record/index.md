...
| Integration | `DatabaseConfig`, `DatabaseBackend`, `DatabaseManager`, `setup_record`, `register_db_exception_handlers`, `pydantic_model_from_tortoise`, `QueryLogger`, `QueryLogEntry`, `Seeder`, `FixtureLoader`, `MigrationHelper`, `RecordCLI` | [Exceptions & Pydantic](/guides/record/exceptions-pydantic/), [Migrations & Seeding](/guides/record/migrations/) |
...
:::caution[`from_env(prefix=...)` only prefixes the URL]
...
:::danger[`DatabaseManager` cannot connect to PostgreSQL, MySQL, or MariaDB as written]
...
- [Migrations & Seeding](/guides/record/migrations/) — aerich, seeders, and fixtures
