...
- [Models & Mixins](/guides/record/models/): `bulk_create`, `upsert`, and
  validation hooks
- [Scopes & Events](/guides/record/scopes-events/): why lifecycle events do not
  fire inside `create()`
- [Migrations & Seeding](/guides/record/migrations/): seeders and fixtures for
  non-test data
- [Exception Handlers & Pydantic](/guides/record/exceptions-pydantic/): turning
  `IntegrityError` into a 409
- [Concurrency](/guides/concurrency/): how sillo schedules the tasks these run
  in
