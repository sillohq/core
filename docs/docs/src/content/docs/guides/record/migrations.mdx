...
<Aside type="danger" title="MigrationHelper does not do what its signature says">
...
<Aside type="caution" title="sillo record ... is not a command">
...
<Aside type="danger" title="FixtureLoader reads files and inserts nothing">
