...
[queue](/guides/work/queue/), not in a shutdown handler.
...
Anything per-request. That is [middleware](/guides/middleware/) or a
...
- [Middleware](/guides/middleware/): per-request work, as opposed to
  per-process
...
- [The Console](/guides/start/console/): the commands a project ships with, and
