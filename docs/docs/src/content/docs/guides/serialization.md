...
[`response_model`](/guides/validation/response-models/), which drops
...
[Streaming Responses](/guides/streaming-response/).
...
models. See [Request Bodies](/guides/validation/request-bodies/) for the
