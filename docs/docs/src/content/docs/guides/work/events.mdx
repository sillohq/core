...
- [Work Overview](/guides/work/): where the shared dispatcher lives in
  `app.state`
...
- [Background Tasks](/guides/work/background/): the other fire-and-forget
  option
- [Events (`sillo.events`)](/guides/events/): the separate application-level
  emitter
