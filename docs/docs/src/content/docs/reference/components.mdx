...
<LinkButton href="/guides/installation/" variant="primary">
  Install
</LinkButton>
{' '}
<LinkButton href="/showcase/starlight-components/" variant="secondary">
  Showcase
</LinkButton>
{' '}
...
<LinkButton href="/guides/installation/" variant="primary" size="md">
  Install
</LinkButton>
```
...
- [Starlight Components](/showcase/starlight-components/) previews the component surface.
