...
The manager on `app.state` is what the [`sillo` command](/cli/) looks for. Find
...
`sillo.admin.models` is required if you mount the [admin panel](/orm/admin/):
