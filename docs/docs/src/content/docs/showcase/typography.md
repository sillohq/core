...
This paragraph includes **bold text**, *italic text*, `inline code`, and a [link to the component showcase](/showcase/starlight-components/). It also includes a keyboard hint: press <kbd>Ctrl</kbd> + <kbd>K</kbd> to open search.
