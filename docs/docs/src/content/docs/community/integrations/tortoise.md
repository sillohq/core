...
description: Seamless integration between sillo and Tortoise ORM for async database operations.
---

# Tortoise ORM Integration

The `sillo_contrib.tortoise` package provides seamless integration between sillo and [Tortoise ORM](https://tortoise.github.io/), an easy-to-use asyncio ORM inspired by Django ORM.
...
```python
from sillo_contrib.tortoise import TortoiseConfig
...
Initialize Tortoise ORM for a sillo application.

**Parameters:**
- `app`: The sillo application instance
