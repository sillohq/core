...
description: A lightweight production-ready ETag middleware for the sillo ASGI framework.
---

# ETag Middleware

A lightweight, production‑ready ETag middleware for the sillo ASGI framework.
