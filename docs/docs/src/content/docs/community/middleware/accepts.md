...
A comprehensive content negotiation middleware for the sillo ASGI framework that handles Accept headers and provides intelligent content negotiation.
...
```python
from sillo import silloApp
from sillo_contrib.accepts import ContentNegotiationMiddleware, negotiate_content_type
...
```python
from sillo import silloApp
from sillo_contrib.accepts import StrictContentNegotiationMiddleware
...
```python
from sillo_contrib.accepts import get_best_match, negotiate_content_type
...
```python
from sillo_contrib.accepts import parse_accept_header, parse_accept_language
...
```python
from sillo_contrib.accepts import negotiate_content_type, negotiate_language
...
```python
from sillo_contrib.accepts import get_best_match
