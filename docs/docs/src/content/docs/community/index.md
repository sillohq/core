...
title: Community
icon: community
description: 'The sillo community is a place for developers to connect, share knowledge, and help each other build amazing applications with sillo.
...
- tag: meta
  attrs:
    ...
    content: The sillo community is a place for developers to connect, share knowledge, and help each other build amazing applications with sillo.
---
#  Welcome to the sillo Community!

We're thrilled to have you here! The sillo community is a place for developers to connect, share knowledge, and help each other build amazing applications with sillo.
...
The **sillo-contrib** package is our community-driven collection of extensions, middleware, and add-ons that extend sillo's capabilities. It includes:
