...
definition. See [Types](/v1.0/pydantic/types/#strict-mode).
...
looks like JavaScript. See [Fields](/v1.0/pydantic/fields/#aliases).
...
[Record model](/v1.0/orm/models/), and remember to
[fetch the relations first](/v1.0/pydantic/nested/#building-from-orm-objects).
...
Both flow into the [OpenAPI document](/v1.0/pydantic/openapi/). A worked example at
