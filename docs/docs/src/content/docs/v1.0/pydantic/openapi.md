...
The [parameter markers](/v1.0/pydantic/parameters/) take the same constraint
...
[Generic models](/v1.0/pydantic/models/#generic-models) get generated names
...
[Nested models](/v1.0/pydantic/nested/#discriminated-unions).
...
It does not make the route private. Use [auth](/v1.0/guides/protecting-routes/) for
that. An undocumented endpoint is still an endpoint.

## Viewing it

The [documentation UI](/v1.0/guides/openapi/documentation-ui/) renders it, and the
raw document is served alongside. See
[the OpenAPI guides](/v1.0/guides/openapi/) for configuring the title, version,
...
- **A [custom serialiser](/v1.0/pydantic/serialization/#custom-serialisers)** can
