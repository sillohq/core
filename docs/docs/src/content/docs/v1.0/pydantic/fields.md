...
[OpenAPI schema](/v1.0/pydantic/openapi/).
...
schema](/v1.0/pydantic/openapi/), which is what an API reference and a generated
client read.
...
[Patterns](/v1.0/pydantic/patterns/). A field that is excluded is still a field
