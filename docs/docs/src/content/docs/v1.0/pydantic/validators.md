...
[`Field()` constraints](/v1.0/pydantic/fields/) cover bounds, lengths and patterns.
...
with [`Field()`](/v1.0/pydantic/fields/):
...
Covered in [Serialisation](/v1.0/pydantic/serialization/).
...
| An invariant of the row | [`ValidatesBeforeSaveMixin`](/v1.0/orm/mixins/#validatesbeforesavemixin) |
| What must hold for every writer | A [database constraint](/v1.0/orm/meta/#constraints) |
...
handlers](/v1.0/orm/exceptions/) already turn into a 409.
...
[Validation errors](/v1.0/pydantic/errors/).
