...
[validation alias](/v1.0/pydantic/fields/#aliases), the path shows the wire name the
...
[`response_model`](/v1.0/pydantic/response-models/) does not permit, that is a
...
Useful in a [console command](/v1.0/cli/custom-commands/) or a queued job, where
