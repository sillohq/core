...
This is what Sillo calls for a [request body](/v1.0/pydantic/request-models/).
...
for the response. See [Patterns](/v1.0/pydantic/patterns/).
...
[model validator](/v1.0/pydantic/validators/) or a defaulted field depends on an
...
[Types](/v1.0/pydantic/types/#coercion).
...
[Validators](/v1.0/pydantic/validators/).
...
`model_json_schema()` is what [OpenAPI generation](/v1.0/pydantic/openapi/) is built
