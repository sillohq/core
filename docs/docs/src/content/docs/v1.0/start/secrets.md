...
- [Configuration](/v1.0/guides/configuration/): how the application reads these.
- [Environment & .env](/v1.0/guides/environment/): the file format, and when sillo
  reads it.
- [Personalisation](/v1.0/start/personalisation/): the other half of what happens
  after a fetch.
