...
[next steps](/v1.0/start/create-app/#what-it-prints) are phrased.
...
Four are supported, for the [Inertia starter](/v1.0/start/starters/) and anything
...
- [Installing Sillo Start](/v1.0/start/install/): installing the tool itself.
- [After creating](/v1.0/start/after-creating/): the install step in context.
