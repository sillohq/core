...
| [`sillohq/starter-inertia`](https://github.com/sillohq/starter-inertia) | The same application with a React or Vue frontend over [Inertia.js](/v1.0/guides/inertia/). |
...
[why a starter](/v1.0/start/#a-starter-repository-not-a-generator).
...
server. See [Database setup](/v1.0/orm/setup/).
...
See [Custom starters](/v1.0/start/custom-starters/) for what makes a repository work
well as one.
