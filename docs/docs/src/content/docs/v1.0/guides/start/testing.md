...
- [Creating a Project](/v1.0/guides/start/): what CI does on the starter itself
- [The Console](/v1.0/guides/start/console/): the commands CI drives
- [Background Work](/v1.0/guides/start/background-work/): testing jobs
- [Deployment](/v1.0/guides/start/deployment/): what to check before shipping
