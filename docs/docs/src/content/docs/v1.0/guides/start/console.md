...
```bash
uv run sillo dev                          # development
uv run sillo dev --port 9000
...
[Console Commands](/v1.0/guides/console/).
...
- [Console Commands](/v1.0/guides/console/): the toolkit underneath, in full
- [Database](/v1.0/guides/start/database/): what the migration commands act on
- [Background Work](/v1.0/guides/start/background-work/): the queue and scheduler
- [Deployment](/v1.0/guides/start/deployment/): running these in production
