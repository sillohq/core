...
from nothing in about a minute, and [Routing](/v1.0/guides/routing/) →
[Handlers](/v1.0/guides/handlers/) → [Validation](/v1.0/guides/validation/) is enough to
...
The [Inertia](/v1.0/guides/inertia/) section covers it.
:::
...
Migrations](/v1.0/guides/start/database/#another-database).
...
| **API** | JSON routes under `/api`, documented by [Atlas](/v1.0/guides/openapi/documentation-ui/#atlas) at `/docs` |
...
- **No background jobs.** `app/jobs/` is an empty package. What a job
  ...
  [Background Work](/v1.0/guides/start/background-work/).
- **No second user model.** The admin signs people in with your `User`.
  See [Users & Authentication](/v1.0/guides/start/authentication/).
...
Console](/v1.0/guides/start/console/).
...
- [Project Structure](/v1.0/guides/start/structure/): every directory, and why it
  exists
- [The Console](/v1.0/guides/start/console/): every command in full
- [Database & Migrations](/v1.0/guides/start/database/): models, migrations, other
  databases
- [Users & Authentication](/v1.0/guides/start/authentication/): the one user model
- [The Admin Panel](/v1.0/guides/start/admin/): registering models, who may enter
- [Background Work](/v1.0/guides/start/background-work/): jobs, workers, scheduled
  tasks
- [Testing](/v1.0/guides/start/testing/): the suite, the smoke test, and what each
  is for
- [Deployment](/v1.0/guides/start/deployment/): taking it to production
