...
return json(_serialize(user), status_code=201)
```
...
- [The Console](/v1.0/guides/start/console/): `worker` and `scheduler`
- [Project Structure](/v1.0/guides/start/structure/): `app/jobs/` and `app/tasks/`
- [Deployment](/v1.0/guides/start/deployment/): running workers alongside the app
- [Concurrency](/v1.0/guides/concurrency/): the framework-level model
