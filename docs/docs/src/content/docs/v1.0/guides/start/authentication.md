...
async def login_route(ctx: HttpContext, payload):
...
if user is None or not user.is_authenticated:
    return json({"detail": "Not authenticated."}, status_code=401)
```
:::
...
- [Protecting Routes](/v1.0/guides/protecting-routes/): guards and permissions
- [Hashing](/v1.0/guides/hashing/): the password hashing scheme
