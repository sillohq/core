...
process. See [Background Work](/v1.0/guides/start/background-work/).
...
[Deployment](/v1.0/guides/start/deployment/#static-files).
...
See [The Console](/v1.0/guides/start/console/).
...
Both are covered in [Testing](/v1.0/guides/start/testing/).
...
- [Creating a Project](/v1.0/guides/start/): how the files got here
- [The Console](/v1.0/guides/start/console/): every command in full
- [Database & Migrations](/v1.0/guides/start/database/): models and schema changes
- [Middleware](/v1.0/guides/middleware/): the ordering rules in general
- [Routers & Sub-Apps](/v1.0/guides/routers-and-subapps/): mounting and prefixes
