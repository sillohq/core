...
| `Channel` | A connection plus a payload type and an expiry | [Channels](/v1.0/guides/websockets/channels/) |
| `ChannelBox` | Named groups of channels and broadcast | [Groups](/v1.0/guides/websockets/groups/) |
| `WebSocketConsumer` | A class with lifecycle hooks and group helpers | [Consumers](/v1.0/guides/websockets/consumer/) |
...
- [Consumers](/v1.0/guides/websockets/consumer/): the class-based API with lifecycle
  hooks
- [Channels](/v1.0/guides/websockets/channels/): wrapping a connection with a
  payload type and expiry
- [Groups](/v1.0/guides/websockets/groups/): broadcasting to many connections
