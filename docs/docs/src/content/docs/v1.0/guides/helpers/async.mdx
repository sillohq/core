...
[Deprecation](/v1.0/guides/helpers/deprecation/); every other module in this section is
under `sillo.helpers`.
...
- [Handlers](/v1.0/guides/handlers/): how sillo dispatches sync and async route
  handlers
- [Middleware](/v1.0/guides/middleware/): the main place these helpers appear in
  user code
- [Concurrency](/v1.0/guides/concurrency/): running blocking work without stalling
  the loop
- [Retry](/v1.0/guides/helpers/retry/): uses `is_async_callable` to pick a wrapper
- [Request Lifecycle](/v1.0/guides/request-lifecycle/): where dispatch decisions are
  made
