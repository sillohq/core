...
- [OpenAPI Overview](/v1.0/guides/openapi/): how the document is generated
- [OpenAPI Customization](/v1.0/guides/openapi/customizing-openapi-configuration/):
  title, servers, security schemes
- [Static Files](/v1.0/guides/static-files/): serving self-hosted viewer assets
- [Protecting Routes](/v1.0/guides/protecting-routes/): putting the schema behind
  auth
