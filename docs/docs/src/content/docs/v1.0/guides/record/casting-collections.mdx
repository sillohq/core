...
are covered in [Models & Mixins](/v1.0/guides/record/models/).
...
- [Models & Mixins](/v1.0/guides/record/models/): accessors, mutators, and
  serialization
- [Record Overview](/v1.0/guides/record/): setup and configuration
- [Scopes & Events](/v1.0/guides/record/scopes-events/): reusable query constraints
- [Pagination](/v1.0/guides/record/pagination/): bounding result sets before
  collecting them
- [Crypto helpers](/v1.0/guides/helpers/crypto/): proper symmetric encryption and
  HMAC
