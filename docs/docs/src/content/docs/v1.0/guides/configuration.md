...
[Environment & .env](/v1.0/guides/environment/) for the file format and the
precedence rules.
...
The full grammar is in [Environment & .env](/v1.0/guides/environment/).
...
- [Environment & .env](/v1.0/guides/environment/) - The file format, precedence, and `sillo.env`
- [Security](/v1.0/guides/security) - Security best practices
- [Deployment](/v1.0/guides/start/deployment/) - Deployment configuration
