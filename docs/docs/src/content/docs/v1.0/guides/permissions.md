...
async def delete_post(ctx: HttpContext, id: int):
    ...
```
...
- [Protecting Routes](/v1.0/guides/protecting-routes/): route-level gating with
  `useAuth`
- [Users & User Models](/v1.0/guides/users/): user base model, custom user classes
