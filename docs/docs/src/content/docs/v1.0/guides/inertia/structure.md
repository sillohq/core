...
[Project Structure](/v1.0/guides/start/structure/) for that boundary and why it
...
- [Pages and Props](/v1.0/guides/inertia/pages/): writing a page
- [Assets and Deployment](/v1.0/guides/inertia/assets/): what the manifest is for
