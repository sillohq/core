...
Project](/v1.0/guides/start/#install-sillo-start).
...
Everything on [Creating a Project](/v1.0/guides/start/) applies here too. The
...
```bash
sillo dev                    # the application, on :8000
...
| | |
| --- | --- |
| `sillo dev` | The application, with reload. Needs `npm run dev` alongside |
...
See [The Console](/v1.0/guides/start/console/) for what the `sillo` commands do and
how to add your own.
...
- [Project Structure](/v1.0/guides/inertia/structure/): what is in the box and where
  it lives
- [Pages and Props](/v1.0/guides/inertia/pages/): adding a page of your own
