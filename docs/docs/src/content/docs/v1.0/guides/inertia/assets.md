...
Inertia(app, root_view=..., version=read_manifest_hash)  # re-read per ctx
```
...
Everything on [Deployment](/v1.0/guides/start/deployment/) applies. Three things
are specific here:
...
- [Deployment](/v1.0/guides/start/deployment/): everything both starters share
- [Static Files](/v1.0/guides/static-files/): the file server itself
