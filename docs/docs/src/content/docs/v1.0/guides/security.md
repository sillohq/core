...
with its own middleware (see [CORS](/v1.0/guides/cors/)).
</aside>
...
- [CORS](/v1.0/guides/cors/): cross-origin access as its own middleware
- [CSRF](/v1.0/guides/csrf/): synchronizer-token protection for state-changing
  requests
- [Authentication](/v1.0/guides/authentication/): verifying who the caller is
- [Rate Limiting](/v1.0/guides/rate-limiting/): throttling abuse
...
path, and uploads. [Validate](/v1.0/guides/validation/) shape at the boundary, and
...
general-purpose one. See [Hashing helpers](/v1.0/guides/helpers/hashing/).
...
fetching. See [Protecting Routes](/v1.0/guides/protecting-routes/).
...
credentials. See [CSRF](/v1.0/guides/csrf/).
...
**Do not roll your own crypto.** Use the [helpers](/v1.0/guides/helpers/crypto/),
...
- [Validation](/v1.0/guides/validation/): bounding what you accept
- [Authentication](/v1.0/guides/authentication/): establishing identity
- [Permissions](/v1.0/guides/permissions/): deciding what is allowed
- [Protecting Routes](/v1.0/guides/protecting-routes/): enforcing it
- [CSRF](/v1.0/guides/csrf/) and [CORS](/v1.0/guides/cors/): cross-origin concerns
- [Headers](/v1.0/guides/headers/): the security header set
- [Error Handling](/v1.0/guides/error-handling/): not leaking internals
- [Crypto helpers](/v1.0/guides/helpers/crypto/) and [Hashing helpers](/v1.0/guides/helpers/hashing/)
