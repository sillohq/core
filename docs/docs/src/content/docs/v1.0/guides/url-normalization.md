...
- [Routing](/v1.0/guides/routing/): how the canonical path is matched
- [Static Files](/v1.0/guides/static-files/): assets skipped by normalization
- [Middleware](/v1.0/guides/middleware/): ordering `Normalize` in the chain
