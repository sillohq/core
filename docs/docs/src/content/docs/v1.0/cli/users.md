...
[sillo's own `User`](/v1.0/guides/users/) when the project has not defined one.
...
[Building a console](/v1.0/cli/standalone-consoles/).

## See also

- [Users and user models](/v1.0/guides/users/)
- [Permissions](/v1.0/guides/permissions/): groups and per-object rules, which are
