...
See [Arguments, options and flags](/v1.0/cli/arguments/) for the full declaration
surface.
...
set up. It matters for a [console of your own](/v1.0/cli/standalone-consoles/),
...
[Building a console](/v1.0/cli/standalone-consoles/#function-form). The class form
is the primary one and is what anything with a real body should use.

## See also

- [Arguments, options and flags](/v1.0/cli/arguments/)
- [Output](/v1.0/cli/output/): tables, pairs, panels, progress bars.
- [Prompts](/v1.0/cli/prompts/): asking questions safely.
