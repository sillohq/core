...
Plus the [six Record adds](/v1.0/orm/fields/): `PasswordField`, `SlugField`,
...
`UpdatedAtField`](/v1.0/orm/fields/#the-timestamp-fields) wrap, and why you rarely
write these yourself. The [base model](/v1.0/orm/models/) already has both.
...
[`ULIDField`](/v1.0/orm/fields/#ulidfield) is the middle ground, sorting by creation
...
usual set. See [Lookups](/v1.0/orm/lookups/#json-fields).
...
Related: the [`json` cast](/v1.0/orm/casting/) does the same conversion over a
...
| A value derived from other fields | A [model event](/v1.0/orm/events/) |
| A value that must always hold | A [check constraint](/v1.0/orm/meta/#constraints) |
...
For a conversion that needs no new column type, [casting](/v1.0/orm/casting/) is
...
- [Record's own fields](/v1.0/orm/fields/): `PasswordField`, `SlugField`,
  `ULIDField`
- [Relationships](/v1.0/orm/relationships/): the relational field types
- [Meta and indexes](/v1.0/orm/meta/): constraints, indexes, table options
