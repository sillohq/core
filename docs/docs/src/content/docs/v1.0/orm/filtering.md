...
[prefetch](/v1.0/orm/eager-loading/) is usually faster. Check with
...
[parameterised raw query](/v1.0/orm/raw-sql/) where you can bind properly.
:::
...
| A whole query the ORM lacks | [raw SQL](/v1.0/orm/raw-sql/) |
...
- [Lookups](/v1.0/orm/lookups/): everything after `__`
- [Aggregation](/v1.0/orm/aggregation/): `annotate`, `Count`, `Sum`
- [Raw SQL](/v1.0/orm/raw-sql/)
