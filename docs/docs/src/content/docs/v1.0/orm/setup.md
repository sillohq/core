...
The manager on `app.state` is what the [`sillo` command](/v1.0/cli/) looks for. Find
...
context. Use [background tasks](/v1.0/guides/work/background/), which carry it.
...
Which is what a script or a standalone [console](/v1.0/cli/standalone-consoles/)
...
See [Migrations](/v1.0/orm/migrations/).
...
- [Configuration](/v1.0/orm/configuration/): every setting and its environment
  variable.
- [Database commands](/v1.0/cli/database/): the CLI this setup unlocks.
