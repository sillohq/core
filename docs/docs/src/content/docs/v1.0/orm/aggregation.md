...
Which is clumsy enough that a [raw query](/v1.0/orm/raw-sql/) is often clearer for a
...
updated with [`F`](/v1.0/orm/filtering/#f-referring-to-a-column) on write.

Check what a query actually does with [`explain()`](/v1.0/orm/queries/#explain).

## See also

- [Values and projections](/v1.0/orm/values/#group_by)
- [Filtering with Q and F](/v1.0/orm/filtering/)
- [Queries](/v1.0/orm/queries/#count_by): `count_by`
