...
- [`ForeignKeyField`](/v1.0/orm/relationships/#foreign-keys)
- [`OneToOneField`](/v1.0/orm/relationships/#one-to-one)
...
- [many-to-many](/v1.0/orm/relationships/#many-to-many) (`post.tags`)
...
The honest check is [`explain()`](/v1.0/orm/queries/#explain) and the query count,
not intuition.

## Projections instead

Sometimes the relation is wanted for one column, and a
[projection](/v1.0/orm/values/) is cheaper than loading the object at all:
