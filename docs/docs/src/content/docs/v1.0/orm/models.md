...
Prefer a [Pydantic response model](/v1.0/orm/pydantic/), which states the shape once
...
use [`upsert`](/v1.0/orm/bulk/#upsert), which is one statement.
:::
...
for. To make it automatic, add a [global scope](/v1.0/orm/scopes/#global-scopes).
:::

More in [Mixins](/v1.0/orm/mixins/#softdeletesmixin).
...
[global scopes](/v1.0/orm/scopes/). If you set your own `manager`, subclass
...
files](/v1.0/start/personalisation/#model-files) when it renames a project.
:::

## The rest

- [Fields](/v1.0/orm/fields/): the field types Record adds
- [Mass assignment](/v1.0/orm/mass-assignment/): `fillable` and `guarded`
- [Mixins](/v1.0/orm/mixins/): the composable behaviours
