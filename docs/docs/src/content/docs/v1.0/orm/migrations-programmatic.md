...
operations the [CLI](/v1.0/cli/database/) exposes, without the argument parsing or
the output.
...
[CLI](/v1.0/cli/database/) additionally accepts a *callable* returning one, resolved
per command.
...
- [Building a console](/v1.0/cli/standalone-consoles/#record_commands): binding
  these as commands
