...
API](/v1.0/orm/queryset/), [Lookups](/v1.0/orm/lookups/), [Filtering](/v1.0/orm/filtering/),
[Aggregation](/v1.0/orm/aggregation/), [Eager loading](/v1.0/orm/eager-loading/) and
[Values](/v1.0/orm/values/).
...
For an HTTP endpoint, the [pagination system](/v1.0/orm/pagination/) is usually the
...
[transaction](/v1.0/orm/transactions/) if your database and your patience allow.
...
Related: [`DB_ECHO`](/v1.0/orm/configuration/#echo) logs every statement, which is
...
When none of the above can express it, [drop to SQL](/v1.0/orm/raw-sql/):
...
Raw SQL bypasses [global scopes](/v1.0/orm/scopes/), [casts](/v1.0/orm/casting/) and
[events](/v1.0/orm/events/). That is the whole point of it, and the reason to keep
