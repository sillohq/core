...
Returns the instances. [Casts](/v1.0/orm/casting/) are applied. Each instance is
...
[`without_global_scopes()`](/v1.0/orm/scopes/#escaping-them), so upserting a
...
[`get_or_create`](/v1.0/orm/models/#fetch-shortcuts) is a `SELECT` then an `INSERT`,
...
| | Applied? |
| --- | --- |
| [Casts](/v1.0/orm/casting/) | Yes |
| [Model events](/v1.0/orm/events/) | **No** |
| [`ValidatesBeforeSaveMixin`](/v1.0/orm/mixins/#validatesbeforesavemixin) | **No** |
...
batches. A [transaction](/v1.0/orm/transactions/) makes the whole thing one unit.
