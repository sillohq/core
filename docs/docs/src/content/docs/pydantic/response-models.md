...
[every field the model has](/orm/models/#serialisation) and quietly starts
...
For an envelope, use a [generic model](/pydantic/models/#generic-models)
instead:
...
not transfer every post body. See [Patterns](/pydantic/patterns/).
