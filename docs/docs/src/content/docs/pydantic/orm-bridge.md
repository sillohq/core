...
| | [Record model](/orm/models/) | Pydantic model |
| --- | --- | --- |
...
at [Pydantic schemas](/orm/pydantic/) on the ORM side.
...
Same reasoning as [`fillable` over `guarded`](/orm/mass-assignment/#which-to-reach-for)
on the write side.
...
[`fillable`](/orm/mass-assignment/) on the model is the second line of defence
behind both.
...
One enum, used by [`CharEnumField`](/orm/field-reference/#enums) and by the
