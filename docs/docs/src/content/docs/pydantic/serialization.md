...
a `PostOut` model states the shape once. See [Patterns](/pydantic/patterns/).
...
[alias generator](/pydantic/config/) plus `serialize_by_alias`.
...
[`SecretStr`](/pydantic/types/#pydantics-own-types) keeps the value out of
