...
[Types](/pydantic/types/#unions-and-optionals).
...
See [Eager loading](/orm/eager-loading/). This is the single most common cause
...
[`before` model validator](/pydantic/validators/#modebefore):
