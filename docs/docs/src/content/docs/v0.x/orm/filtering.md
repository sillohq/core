...
[prefetch](/v0.x/orm/eager-loading/) is usually faster. Check with
...
[parameterised raw query](/v0.x/orm/raw-sql/) where you can bind properly.
:::
...
| A whole query the ORM lacks | [raw SQL](/v0.x/orm/raw-sql/) |
...
- [Lookups](/v0.x/orm/lookups/): everything after `__`
- [Aggregation](/v0.x/orm/aggregation/): `annotate`, `Count`, `Sum`
- [Raw SQL](/v0.x/orm/raw-sql/)
