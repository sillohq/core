...
- [global scopes](/v0.x/orm/scopes/#global-scopes): including a soft-delete filter;
- [casts](/v0.x/orm/casting/): you get the raw column value;
- [model events](/v0.x/orm/events/) and
  [validation](/v0.x/orm/mixins/#validatesbeforesavemixin);
- `updated_at`.
...
scopes, casts and the ability to compose with a [scope](/v0.x/orm/scopes/).

Before dropping down, check whether one of these covers it:

| Need | Tool |
| --- | --- |
| OR, negation | [`Q`](/v0.x/orm/filtering/#q-or-and-and-negation) |
| Column arithmetic | [`F`](/v0.x/orm/filtering/#f-referring-to-a-column) |
| A conditional value | [`Case`/`When`](/v0.x/orm/filtering/#case--when-conditionals-in-sql) |
| A set from another query | [`Subquery`](/v0.x/orm/filtering/#subquery) |
| One expression the ORM lacks | [`RawSQL`](/v0.x/orm/filtering/#rawsql) in an annotation |

[`RawSQL`](/v0.x/orm/filtering/#rawsql) in particular is the middle ground: one raw
...
[Connections](/v0.x/orm/connections/).
