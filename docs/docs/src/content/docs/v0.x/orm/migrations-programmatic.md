...
operations the [CLI](/v0.x/cli/database/) exposes, without the argument parsing or
the output.
...
[CLI](/v0.x/cli/database/) additionally accepts a *callable* returning one, resolved
per command.
...
- [How migrations work](/v0.x/orm/migrations/)
- [Building a console](/v0.x/cli/standalone-consoles/#record_commands): binding
  these as commands
