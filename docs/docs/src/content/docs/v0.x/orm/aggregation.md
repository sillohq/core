...
Which is clumsy enough that a [raw query](/v0.x/orm/raw-sql/) is often clearer for a
...
updated with [`F`](/v0.x/orm/filtering/#f-referring-to-a-column) on write.

Check what a query actually does with [`explain()`](/v0.x/orm/queries/#explain).

## See also

- [Values and projections](/v0.x/orm/values/#group_by)
- [Filtering with Q and F](/v0.x/orm/filtering/)
- [Queries](/v0.x/orm/queries/#count_by): `count_by`
