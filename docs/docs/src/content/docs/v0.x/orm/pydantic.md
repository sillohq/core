...
[appears in the OpenAPI document](/v0.x/guides/validation/openapi/).
...
- [Validation](/v0.x/guides/validation/): how request models are used.
- [Response models](/v0.x/guides/validation/response-models/).
- [Exception handlers](/v0.x/orm/exceptions/): turning database errors into
  responses.
