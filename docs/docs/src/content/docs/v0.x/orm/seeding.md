...
[`bulk_create`](/v0.x/orm/bulk/) directly.
:::

Each row goes through `create()`, so [model events](/v0.x/orm/events/),
[casts](/v0.x/orm/casting/) and [validation](/v0.x/orm/mixins/#validatesbeforesavemixin)
...
- [Factories](/v0.x/orm/factories/): for test data, generated per test.
- [Bulk operations](/v0.x/orm/bulk/): for large volumes.
- [Migrations](/v0.x/orm/migrations/): for data that must exist everywhere.
