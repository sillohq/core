...
- [Protecting Routes](/v0.x/guides/protecting-routes/): route-level gating with
  `useAuth`
- [Users & User Models](/v0.x/guides/users/): user base model, custom user classes
...
Events](/v0.x/guides/record/scopes-events/), including its warning that scopes do
