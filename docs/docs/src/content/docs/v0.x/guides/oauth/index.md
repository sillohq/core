...
[The security model](/v0.x/guides/oauth/security/) for why, and what that buys.
...
- [Providers](/v0.x/guides/oauth/providers/): the four shipped, and how to add any
  other.
- [Persisting the login](/v0.x/guides/oauth/persisting-logins/): session, JWT,
  account linking, or nothing.
- [OAuth in OpenAPI](/v0.x/guides/oauth/openapi/): what your API reference should
  say about all this.
- [The security model](/v0.x/guides/oauth/security/): state, PKCE, and what is
