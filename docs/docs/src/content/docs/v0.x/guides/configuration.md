...
[Environment & .env](/v0.x/guides/environment/) for the file format and the
precedence rules.
...
The full grammar is in [Environment & .env](/v0.x/guides/environment/).
...
- [Environment & .env](/v0.x/guides/environment/) - The file format, precedence, and `sillo.env`
- [Security](/v0.x/guides/security) - Security best practices
- [Deployment](/v0.x/guides/start/deployment/) - Deployment configuration
