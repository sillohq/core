...
- [OpenAPI Overview](/v0.x/guides/openapi/): how the document is generated
- [OpenAPI Customization](/v0.x/guides/openapi/customizing-openapi-configuration/):
  title, servers, security schemes
- [Static Files](/v0.x/guides/static-files/): serving self-hosted viewer assets
- [Protecting Routes](/v0.x/guides/protecting-routes/): putting the schema behind
  auth
