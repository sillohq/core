...
[queue](/v0.x/guides/work/queue/), not in a shutdown handler.
...
Anything per-request. That is [middleware](/v0.x/guides/middleware/) or a
[dependency](/v0.x/guides/dependency-injection/).
...
[Scheduler](/v0.x/guides/work/scheduler/) for leader election and locking.
...
- [Middleware](/v0.x/guides/middleware/): per-request work, as opposed to
  per-process
- [Dependency Injection](/v0.x/guides/dependency-injection/): per-request resources
- [Record Overview](/v0.x/guides/record/): `setup_record` and the hooks it registers
- [Background Tasks](/v0.x/guides/work/background/): draining before exit
- [Work Overview](/v0.x/guides/work/): the scheduler's start and stop hooks
- [The Console](/v0.x/guides/start/console/): the commands a project ships with, and
