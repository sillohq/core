...
answer. That is what a [queue worker](/v0.x/guides/work/queue/) gives you, and
...
callback that logs, or use [`BackgroundTask`](/v0.x/guides/work/background/), which
...
- [Background Tasks](/v0.x/guides/work/background/): managed fire-and-forget with
  result tracking
- [Work Overview](/v0.x/guides/work/): moving heavy work out of the web process
  entirely
- [HTTP Client](/v0.x/guides/http/client/): timeouts, pooling, and gathering
  upstream calls
- [Async helpers](/v0.x/guides/helpers/async/): the utilities that complement these
  primitives
- [Middleware](/v0.x/guides/middleware/): where a blocking call hurts most
