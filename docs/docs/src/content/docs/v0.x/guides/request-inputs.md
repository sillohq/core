...
See [Request Parameters](/v0.x/guides/request-parameters/) and the dependency
...
- [Request Parameters](/v0.x/guides/request-parameters/): `Query`, `Header`,
  `Cookie` extractors
- [Request Information](/v0.x/guides/request-info/): headers, cookies, client IP,
  type flags
- [Sending Responses](/v0.x/guides/sending-responses/): returning data, errors,
  files
- [File Uploads](/v0.x/guides/file-upload/): the dedicated file-upload guide

##  Related topics

- [Error Handling](/v0.x/guides/error-handling/): returning structured 4xx/5xx
  responses
- [Middleware](/v0.x/guides/middleware/): reading the body inside middleware
