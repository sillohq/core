...
[Deprecation](/v0.x/guides/helpers/deprecation/); every other module in this section is
under `sillo.helpers`.
...
- [Handlers](/v0.x/guides/handlers/): how sillo dispatches sync and async route
  handlers
- [Middleware](/v0.x/guides/middleware/): the main place these helpers appear in
  user code
- [Concurrency](/v0.x/guides/concurrency/): running blocking work without stalling
  the loop
- [Retry](/v0.x/guides/helpers/retry/): uses `is_async_callable` to pick a wrapper
- [Request Lifecycle](/v0.x/guides/request-lifecycle/): where dispatch decisions are
  made
