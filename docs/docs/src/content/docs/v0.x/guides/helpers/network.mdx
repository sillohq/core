...
For production rate limiting use the built-in middleware in [Rate Limiting](/v0.x/guides/rate-limiting/) rather than writing your own; the example above is to show where the IP comes from.
...
- [Rate Limiting](/v0.x/guides/rate-limiting/): the main consumer of client IP
- [Request Information](/v0.x/guides/request-info/): reading headers and the peer
  address
- [Security](/v0.x/guides/security/): trusted hosts and the wider hardening story
- [Middleware](/v0.x/guides/middleware/): where IP resolution usually belongs
