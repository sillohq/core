...
[Instance Registry](/v0.x/advanced/context-binding/) — nothing here depends on
knowing.)
...
- [Storage internals](/v0.x/advanced/storage/) — the driver contract, the design
  decisions, and where "S3-compatible" leaks
- [File uploads](/v0.x/guides/file-upload/) — parsing multipart before it reaches a
  bucket
