...
should have that listener enqueue a [job](/v0.x/guides/work/jobs/).

Note that `sillo` has a second, unrelated event system:
[`sillo.events`](/v0.x/guides/events/), with its own emitter, priorities, and
...
- [Work Overview](/v0.x/guides/work/): where the shared dispatcher lives in
  `app.state`
- [Jobs](/v0.x/guides/work/jobs/): what a critical listener should enqueue
- [Queue System](/v0.x/guides/work/queue/): durability for consequences that matter
- [Background Tasks](/v0.x/guides/work/background/): the other fire-and-forget
  option
- [Events (`sillo.events`)](/v0.x/guides/events/): the separate application-level
  emitter
