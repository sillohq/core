...
scope. See [Scopes & Events](/v0.x/guides/record/scopes-events/).
...
a [transaction](/v0.x/guides/record/transactions-factories/).
...
- [Record Overview](/v0.x/guides/record/): setup, configuration, and connection
  lifecycle
- [Scopes & Events](/v0.x/guides/record/scopes-events/): global scopes for automatic
  soft-delete filtering
- [Casting & Collections](/v0.x/guides/record/casting-collections/): `_casts` and
  result manipulation
- [Exception Handlers & Pydantic](/v0.x/guides/record/exceptions-pydantic/):
  generating schemas from these models
- [Hashing helpers](/v0.x/guides/helpers/hashing/): what `PasswordField` uses
  internally
