...
described in [Models & Mixins](/v0.x/guides/record/models/). Then:
...
- [Models & Mixins](/v0.x/guides/record/models/): mixin ordering, and
  `ValidatesBeforeSaveMixin` for hooks that can veto
- [Record Overview](/v0.x/guides/record/): setup and connection lifecycle
- [Casting & Collections](/v0.x/guides/record/casting-collections/): transforming
  values on read and write
- [Transactions & Factories](/v0.x/guides/record/transactions-factories/): wrapping
  multi-model writes
- [Events](/v0.x/guides/events/): sillo's application-level event emitter, which
  does fire on its own
- [Middleware](/v0.x/guides/middleware/): where tenant context gets established
