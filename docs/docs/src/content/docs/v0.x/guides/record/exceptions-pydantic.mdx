...
- [Models & Mixins](/v0.x/guides/record/models/): `update_from_dict` and
  mass-assignment safety
- [Transactions & Factories](/v0.x/guides/record/transactions-factories/): where
  `IntegrityError` usually comes from
- [Pagination](/v0.x/guides/record/pagination/): the other place errors need mapping
  to 400
- [Error Handling](/v0.x/guides/error-handling/): sillo's exception middleware in
  general
- [Request Inputs](/v0.x/guides/request-inputs/): how `request_model` validation
