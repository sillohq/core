...
- [Request Inputs](/v0.x/guides/request-inputs/): JSON body parsing used by the
  `POST` handler
- [Authentication](/v0.x/guides/authentication/): protecting the `/graphql` route
- [Middleware](/v0.x/guides/middleware/): ordering auth before the GraphQL route
