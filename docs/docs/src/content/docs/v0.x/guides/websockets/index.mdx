...
| `Channel` | A connection plus a payload type and an expiry | [Channels](/v0.x/guides/websockets/channels/) |
| `ChannelBox` | Named groups of channels and broadcast | [Groups](/v0.x/guides/websockets/groups/) |
| `WebSocketConsumer` | A class with lifecycle hooks and group helpers | [Consumers](/v0.x/guides/websockets/consumer/) |
...
infrastructure. See [Streaming Responses](/v0.x/guides/streaming-response/).
...
- [Consumers](/v0.x/guides/websockets/consumer/): the class-based API with lifecycle
  hooks
- [Channels](/v0.x/guides/websockets/channels/): wrapping a connection with a
  payload type and expiry
- [Groups](/v0.x/guides/websockets/groups/): broadcasting to many connections
- [Events](/v0.x/guides/websockets/events/): routing messages to handlers by type
- [Streaming Responses](/v0.x/guides/streaming-response/): SSE, for one-directional
  push
- [Routing](/v0.x/guides/routing/): how paths and parameters are matched
