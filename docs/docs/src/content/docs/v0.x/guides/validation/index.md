...
The full set is `gt`, `ge`, `lt`, `le`, `multiple_of`, `min_length`, `max_length`, `pattern`, and `strict`. They are covered in depth in [Parameters](/v0.x/guides/validation/parameters/).
...
See [Validation errors](/v0.x/guides/validation/errors/).
...
- **[Parameters](/v0.x/guides/validation/parameters/)**: query strings, headers,
...
- **[Request bodies](/v0.x/guides/validation/request-bodies/)**: `request_model=`,
  ...
  unions.
- **[Forms and file uploads](/v0.x/guides/validation/forms-and-files/)**: urlencoded
  and multipart bodies, the `UploadFile` API, upload validation patterns, and
  the limits worth knowing.
- **[Response models](/v0.x/guides/validation/response-models/)**: enforcing your
  output contract, preventing accidental field leaks, and Pydantic's
  serialization controls in full.
- **[Validation errors](/v0.x/guides/validation/errors/)**: the 422 contract, the
  complete error-type catalog, custom messages, and custom handlers.
- **[Generated documentation](/v0.x/guides/validation/openapi/)**: how declarations
...
[Permissions](/v0.x/guides/permissions/) for the second.
