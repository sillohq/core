...
| Path | What it serves |
| --- | --- |
| `/docs` | [Atlas](/v0.x/guides/openapi/documentation-ui/#atlas): sillo's own reference, with a request builder |
...
argument. See [Documentation UI](/v0.x/guides/openapi/documentation-ui/).
