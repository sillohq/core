...
See [DB-backed permissions](/v0.x/guides/users/#db-backed-permissions) for the full API.
...
- [Permissions](/v0.x/guides/permissions/): full permission system with groups,
  caching, and inheritance
- [Authentication](/v0.x/guides/authentication/): middleware + backend model
- [Users & User Models](/v0.x/guides/users/): `has_permission`, `UserProtocol`
- [JWT](/v0.x/guides/jwt-auth/) · [Sessions](/v0.x/guides/session-auth/) · [API Keys](/v0.x/guides/api-keys/)
...
- [Authentication](/v0.x/guides/authentication/): establishing who the caller is
- [Permissions](/v0.x/guides/permissions/): deciding what they may do
- [Scopes & Events](/v0.x/guides/record/scopes-events/): query-level enforcement
- [Middleware](/v0.x/guides/middleware/): where authentication runs
- [Security](/v0.x/guides/security/): the wider checklist
