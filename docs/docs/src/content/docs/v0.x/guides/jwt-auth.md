...
- [Authentication](/v0.x/guides/authentication/): middleware + backend model
- [Protecting Routes](/v0.x/guides/protecting-routes/):
  `useAuth(schemes=["bearerAuth"])`
- [Users & User Models](/v0.x/guides/users/): `User`, `JWTUserMixin` wiring
- [Sessions](/v0.x/guides/session-auth/) · [API Keys](/v0.x/guides/api-keys/)
...
and reintroduces [CSRF](/v0.x/guides/csrf/), because cookies are sent automatically.
...
- [Authentication](/v0.x/guides/authentication/): choosing between strategies
- [Protecting Routes](/v0.x/guides/protecting-routes/): enforcing the credential
- [JWT helpers](/v0.x/guides/helpers/jwt/): the encoding and decoding utilities
- [Sessions](/v0.x/guides/sessions/): the cookie-based alternative
- [Security](/v0.x/guides/security/): storage and transport concerns
