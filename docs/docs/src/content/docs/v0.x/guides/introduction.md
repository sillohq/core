...
[middleware stack](/v0.x/guides/middleware/), matches it against the
[router](/v0.x/guides/routing/), resolves
[dependencies](/v0.x/guides/dependency-injection/) and
[validates inputs](/v0.x/guides/validation/), calls your
[handler](/v0.x/guides/handlers/), and serializes what comes back.

Around that core sit optional subsystems, each independent: an
[ORM layer](/v0.x/guides/record/), [background work](/v0.x/guides/work/),
[WebSockets](/v0.x/guides/websockets/), [templating](/v0.x/guides/templating/),
[caching](/v0.x/guides/cache/), [mail](/v0.x/guides/services/mail/), and an
[HTTP client](/v0.x/guides/http/client/). None of them are required. An
...
[Error Handling](/v0.x/guides/error-handling/). That is enough to build
something real. Add [Record](/v0.x/guides/record/) when you need a database
and [Authentication](/v0.x/guides/authentication/) when you need users.

**A server-rendered application.** [Routing](/v0.x/guides/routing/) →
[Templating](/v0.x/guides/templating/) → [Sessions](/v0.x/guides/sessions/) →
[CSRF](/v0.x/guides/csrf/). The last is not optional if your forms
authenticate with cookies.

**Something real-time.** [WebSockets](/v0.x/guides/websockets/) first, and
read its scaling section before you design anything, because the answer
changes what you build.

**Anything going to production.** [Security](/v0.x/guides/security/), [Startup &
Shutdown](/v0.x/guides/startups-and-shutdowns/), and
[Concurrency](/v0.x/guides/concurrency/), in that order. The third one is where most
...
Continue with [Installation](/v0.x/guides/installation/) to install Sillo with
