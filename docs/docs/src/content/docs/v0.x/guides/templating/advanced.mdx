...
and key building) documented in [Cache](/v0.x/guides/cache/). The in-memory example
...
- [Templating](/v0.x/guides/templating/): engine setup, autoescaping, and
  configuration
- [Cache](/v0.x/guides/cache/): the real cache module, for fragment and page caching
- [HTML helpers](/v0.x/guides/helpers/html/): escaping and why `sanitize_html` is
  not enough
- [CSRF](/v0.x/guides/csrf/): where `csrf_token` comes from
- [Error Handling](/v0.x/guides/error-handling/): registering the error handlers
  shown above
- [Static Files](/v0.x/guides/static-files/): serving the assets templates reference
