...
- [Routing](/v0.x/guides/routing/): path syntax, converters, `name=`, and all route
  options
- [Handlers](/v0.x/guides/handlers/): the handler contract used inside routers
- [Middleware](/v0.x/guides/middleware/): router-scoped and global middleware
- [Handlers](/v0.x/guides/handlers/): define function handlers for router endpoints
- [Dependency Injection](/v0.x/guides/dependency-injection/): router-level
  `dependencies=`

##  Related topics

- [Startup & Shutdown](/v0.x/guides/startups-and-shutdowns/): run setup when the
  composed app boots
- [Error Handling](/v0.x/guides/error-handling/): exception handlers registered per
  app vs. globally
- [Events](/v0.x/guides/events/): router-level event hooks
