...
Project](/v0.x/guides/start/#install-sillo-start).
...
Everything on [Creating a Project](/v0.x/guides/start/) applies here too. The
...
See [The Console](/v0.x/guides/start/console/) for what the `sillo` commands do and
how to add your own.
...
- [Project Structure](/v0.x/guides/inertia/structure/): what is in the box and where
  it lives
- [Pages and Props](/v0.x/guides/inertia/pages/): adding a page of your own
