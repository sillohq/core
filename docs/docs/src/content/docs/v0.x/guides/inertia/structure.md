...
[Project Structure](/v0.x/guides/start/structure/) for that boundary and why it
...
- [Pages and Props](/v0.x/guides/inertia/pages/): writing a page
- [Assets and Deployment](/v0.x/guides/inertia/assets/): what the manifest is for
