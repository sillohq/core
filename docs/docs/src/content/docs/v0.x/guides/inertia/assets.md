...
Everything on [Deployment](/v0.x/guides/start/deployment/) applies. Three things
are specific here:
...
- [Deployment](/v0.x/guides/start/deployment/): everything both starters share
- [Static Files](/v0.x/guides/static-files/): the file server itself
