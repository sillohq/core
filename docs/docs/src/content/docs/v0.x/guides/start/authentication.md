...
- [The Admin Panel](/v0.x/guides/start/admin/): what `is_staff` gets you into
- [The Console](/v0.x/guides/start/console/): the `user` commands
- [Authentication](/v0.x/guides/authentication/): the framework-level reference
- [JWT Authentication](/v0.x/guides/jwt-auth/): tokens in depth
- [Protecting Routes](/v0.x/guides/protecting-routes/): guards and permissions
- [Hashing](/v0.x/guides/hashing/): the password hashing scheme
