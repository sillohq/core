...
- [Creating a Project](/v0.x/guides/start/): what CI does on the starter itself
- [The Console](/v0.x/guides/start/console/): the commands CI drives
- [Background Work](/v0.x/guides/start/background-work/): testing jobs
- [Deployment](/v0.x/guides/start/deployment/): what to check before shipping
