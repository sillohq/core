...
from nothing in about a minute, and [Routing](/v0.x/guides/routing/) →
[Handlers](/v0.x/guides/handlers/) → [Validation](/v0.x/guides/validation/) is enough to
...
The [Inertia](/v0.x/guides/inertia/) section covers it.
:::
...
Migrations](/v0.x/guides/start/database/#another-database).
...
| **API** | JSON routes under `/api`, documented by [Atlas](/v0.x/guides/openapi/documentation-ui/#atlas) at `/docs` |
...
- **No background jobs.** `app/jobs/` is an empty package. What a job
  ...
  [Background Work](/v0.x/guides/start/background-work/).
- **No second user model.** The admin signs people in with your `User`.
  See [Users & Authentication](/v0.x/guides/start/authentication/).
...
Console](/v0.x/guides/start/console/).
...
- [Project Structure](/v0.x/guides/start/structure/): every directory, and why it
  exists
- [The Console](/v0.x/guides/start/console/): every command in full
- [Database & Migrations](/v0.x/guides/start/database/): models, migrations, other
  databases
- [Users & Authentication](/v0.x/guides/start/authentication/): the one user model
- [The Admin Panel](/v0.x/guides/start/admin/): registering models, who may enter
- [Background Work](/v0.x/guides/start/background-work/): jobs, workers, scheduled
  tasks
- [Testing](/v0.x/guides/start/testing/): the suite, the smoke test, and what each
  is for
- [Deployment](/v0.x/guides/start/deployment/): taking it to production
