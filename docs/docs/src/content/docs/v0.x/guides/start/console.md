...
[Console Commands](/v0.x/guides/console/).
...
- [Console Commands](/v0.x/guides/console/): the toolkit underneath, in full
- [Database](/v0.x/guides/start/database/): what the migration commands act on
- [Background Work](/v0.x/guides/start/background-work/): the queue and scheduler
- [Deployment](/v0.x/guides/start/deployment/): running these in production
