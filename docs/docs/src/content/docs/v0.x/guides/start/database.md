...
- [Project Structure](/v0.x/guides/start/structure/): where the data layer sits
- [The Console](/v0.x/guides/start/console/): the `db` commands in detail
- [Models & Mixins](/v0.x/guides/record/models/): what you can put in a model
- [Migrations & Seeding](/v0.x/guides/record/migrations/): the framework-level
  reference
- [Deployment](/v0.x/guides/start/deployment/): migrating on deploy
