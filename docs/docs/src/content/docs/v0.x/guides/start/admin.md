...
5. **Registering the admin after the middleware block** makes every admin
   ...
   [Project Structure](/v0.x/guides/start/structure/#appbootstrappy).

##  Related

- [Users & Authentication](/v0.x/guides/start/authentication/): the model the admin
  signs in
- [Database & Migrations](/v0.x/guides/start/database/): what `MODEL_MODULES`
  decides
- [Project Structure](/v0.x/guides/start/structure/): where `app/admin.py` sits
- [Middleware](/v0.x/guides/middleware/): why registration order matters
