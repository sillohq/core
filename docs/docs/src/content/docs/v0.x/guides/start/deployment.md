...
- [Creating a Project](/v0.x/guides/start/): what you are deploying
- [Database & Migrations](/v0.x/guides/start/database/): migrating safely
- [Background Work](/v0.x/guides/start/background-work/): workers in production
- [Testing](/v0.x/guides/start/testing/): the suite and the smoke check
- [The Console](/v0.x/guides/start/console/): the commands a deployment runs
