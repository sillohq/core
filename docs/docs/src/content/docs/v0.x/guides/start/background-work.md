...
- [The Console](/v0.x/guides/start/console/): `worker` and `scheduler`
- [Project Structure](/v0.x/guides/start/structure/): `app/jobs/` and `app/tasks/`
- [Deployment](/v0.x/guides/start/deployment/): running workers alongside the app
- [Concurrency](/v0.x/guides/concurrency/): the framework-level model
