...
- [Users & User Models](/v0.x/guides/users/): `SessionUserMixin` wiring
- [JWT](/v0.x/guides/jwt-auth/) · [API Keys](/v0.x/guides/api-keys/)
...
removes the classic [CSRF](/v0.x/guides/csrf/) attack. `Strict` is stronger
...
- [Sessions](/v0.x/guides/sessions/): the session store and its configuration
- [Authentication](/v0.x/guides/authentication/): choosing between strategies
- [CSRF](/v0.x/guides/csrf/): the exposure cookie sessions bring with them
- [Cookies](/v0.x/guides/cookies/): attributes in detail
- [Hashing helpers](/v0.x/guides/helpers/hashing/): verifying passwords
- [Protecting Routes](/v0.x/guides/protecting-routes/): enforcing the session
...
configuration) are in [Sessions](/v0.x/guides/sessions/). This page covers the
