...
- [Security Headers (Shield)](/v0.x/guides/security/): defensive response headers
- [CSRF](/v0.x/guides/csrf/): protect cookie-auth state-changing requests from
  cross-site forgery
...
This is why a form POST is a [CSRF](/v0.x/guides/csrf/) concern while a JSON
...
- [Middleware](/v0.x/guides/middleware/): where CORS belongs in the stack
- [CSRF](/v0.x/guides/csrf/): the other cross-origin concern, and a different one
- [Headers](/v0.x/guides/headers/): the response headers involved
