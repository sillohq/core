...
- **`response`**: a `sillo.http.response.Responder` (also importable as
  ...
  Responses](/v0.x/guides/sending-responses/).
...
See [Request Parameters](/v0.x/guides/request-parameters/) for the full `Query`/`Header`/`Cookie` reference.
...
Set ad-hoc headers with `.set_header(...)` and cookies with `.set_cookie(...)`. See [Headers](/v0.x/guides/headers/) and [Cookies](/v0.x/guides/cookies/).
...
See [Error Handling](/v0.x/guides/error-handling/) for the full picture, including `add_exception_handler` with status-code keys and validation-error mapping.
...
Injection](/v0.x/guides/dependency-injection/).
...
- [Routing](/v0.x/guides/routing/): path syntax, converters, `name=`, and route
  options
- [Request Information](/v0.x/guides/request-info/): every `request.*` attribute
- [Request Parameters](/v0.x/guides/request-parameters/): `Query` / `Header` /
  `Cookie`
- [Sending Responses](/v0.x/guides/sending-responses/): the `response` builder in
  depth
- [Dependency Injection](/v0.x/guides/dependency-injection/): `Depend`, nesting,
  caching, teardown

##  Related topics

- [Error Handling](/v0.x/guides/error-handling/): `HTTPException` and custom
  handlers
- [Routers & Sub-Apps](/v0.x/guides/routers-and-subapps/): group related function
  handlers behind a prefix
- [Middleware](/v0.x/guides/middleware/): logic that wraps handlers for every
  request
...
in the process. See [Concurrency](/v0.x/guides/concurrency/).
...
them with [routers](/v0.x/guides/routers-and-subapps/). A single file of two
