...
helpers](/v0.x/guides/helpers/network/) for the trusted-proxy handling this needs.

**The body**, client-controlled, and the reason
[validation](/v0.x/guides/validation/) exists.
...
- [Headers](/v0.x/guides/headers/): reading and setting them safely
- [Network helpers](/v0.x/guides/helpers/network/): client IP resolution and trusted
  proxies
- [Middleware](/v0.x/guides/middleware/): where request correlation belongs
- [Request Lifecycle](/v0.x/guides/request-lifecycle/): when each of these values
  becomes available
- [Security](/v0.x/guides/security/): what not to trust from a request
...
[Content Negotiation](/v0.x/guides/content-negotiation/).
