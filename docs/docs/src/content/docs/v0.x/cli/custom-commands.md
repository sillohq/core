...
See [Arguments, options and flags](/v0.x/cli/arguments/) for the full declaration
surface.
...
set up. It matters for a [console of your own](/v0.x/cli/standalone-consoles/),
...
[Building a console](/v0.x/cli/standalone-consoles/#function-form). The class form
is the primary one and is what anything with a real body should use.

## See also

- [Arguments, options and flags](/v0.x/cli/arguments/)
- [Output](/v0.x/cli/output/): tables, pairs, panels, progress bars.
- [Prompts](/v0.x/cli/prompts/): asking questions safely.
