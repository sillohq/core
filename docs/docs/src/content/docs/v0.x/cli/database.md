...
`app.state`, which is what [`setup_record`](/v0.x/orm/setup/) puts there. There is
...
[`record_commands`](/v0.x/cli/standalone-consoles/) was bound with; `sillo` binds
...
- [Migrations](/v0.x/orm/migrations/): what the files contain and how they are
  generated.
- [Applying migrations](/v0.x/orm/migrations-applying/): the deployment shape.
