...
`app.state`, what [`setup_scheduler`](/v0.x/guides/work/scheduler/) puts there.
...
[Deployment](/v0.x/guides/start/deployment/).

## See also

- [Scheduler](/v0.x/guides/work/scheduler/): defining tasks and triggers.
- [Queue commands](/v0.x/cli/queues/): the worker the scheduler feeds.
