...
[private repositories are not supported](/v0.x/start/custom-starters/#private-repositories).
...
Applies the [substitutions](/v0.x/start/personalisation/#the-substitutions), updates
...
and exit codes](/v0.x/start/errors/#the-exception-hierarchy).
