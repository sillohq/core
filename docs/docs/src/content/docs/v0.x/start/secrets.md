...
- [Configuration](/v0.x/guides/configuration/): how the application reads these.
- [Environment & .env](/v0.x/guides/environment/): the file format, and when sillo
  reads it.
- [Personalisation](/v0.x/start/personalisation/): the other half of what happens
  after a fetch.
