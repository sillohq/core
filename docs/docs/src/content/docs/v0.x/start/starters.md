...
| [`sillohq/starter-inertia`](https://github.com/sillohq/starter-inertia) | The same application with a React or Vue frontend over [Inertia.js](/v0.x/guides/inertia/). |
...
[why a starter](/v0.x/start/#a-starter-repository-not-a-generator).
...
server. See [Database setup](/v0.x/orm/setup/).
...
Note the absence of `templating`. See [Inertia](/v0.x/guides/inertia/) for the
frontend side.
...
See [Custom starters](/v0.x/start/custom-starters/) for what makes a repository work
well as one.
