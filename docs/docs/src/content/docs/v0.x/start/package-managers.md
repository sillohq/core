...
[next steps](/v0.x/start/create-app/#what-it-prints) are phrased.
...
Four are supported, for the [Inertia starter](/v0.x/start/starters/) and anything
...
- [Installing Sillo Start](/v0.x/start/install/): installing the tool itself.
- [After creating](/v0.x/start/after-creating/): the install step in context.
