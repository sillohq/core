...
Those are the [`sillo` command](/v0.x/cli/), which the project has as soon as its
...
| | |
| --- | --- |
| [Installing](/v0.x/start/install/) | Getting the tool, with and without `uv` |
| [`create-app`](/v0.x/start/create-app/) | Every argument and flag |
| [The starters](/v0.x/start/starters/) | What `sillohq/starter` and `starter-inertia` ship |
| [Project names](/v0.x/start/naming/) | The rules, and the name shapes derived from yours |
| [Personalisation](/v0.x/start/personalisation/) | What is rewritten, and what is left alone |
| [Secrets and `.env`](/v0.x/start/secrets/) | How a new project gets its own keys |
| [After creating](/v0.x/start/after-creating/) | Installing, migrating, first run |
| [Custom starters](/v0.x/start/custom-starters/) | Using and building your own |
| [Package managers](/v0.x/start/package-managers/) | uv, pip, and the frontend ones |
| [Errors and exit codes](/v0.x/start/errors/) | What each failure means |
| [Internals](/v0.x/start/internals/) | Fetching, unpacking, and using it as a library |
...
yet, [Installation](/v0.x/guides/installation/) builds a single-file application
