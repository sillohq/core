...
[Instance Registry](/v0.x/advanced/context-binding/) for the mechanism and the
...
| `Responder.stream` overriding the content type with its `text/plain` default | The same |
