...
[`DecimalField`](/v0.x/orm/field-reference/#numbers) on the ORM side.
...
your [OpenAPI schema](/v0.x/pydantic/openapi/).
...
default](/v0.x/orm/field-reference/#arguments-every-field-takes), where it is a real
bug.
...
[`CharEnumField`](/v0.x/orm/field-reference/#enums) on the model.
...
common v1-to-v2 surprise. See [Models](/v0.x/pydantic/models/#v1-to-v2).
...
union](/v0.x/pydantic/nested/#discriminated-unions). It is faster and produces far
...
[`Field()`](/v0.x/pydantic/fields/) or `Annotated`, which read better and compose:
...
Or on a [parameter marker](/v0.x/pydantic/parameters/):
...
[Validators](/v0.x/pydantic/validators/#reusable-annotated-validators).
