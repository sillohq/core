...
definition. See [Types](/v0.x/pydantic/types/#strict-mode).
...
looks like JavaScript. See [Fields](/v0.x/pydantic/fields/#aliases).
...
[Record model](/v0.x/orm/models/), and remember to
[fetch the relations first](/v0.x/pydantic/nested/#building-from-orm-objects).
...
Both flow into the [OpenAPI document](/v0.x/pydantic/openapi/). A worked example at
