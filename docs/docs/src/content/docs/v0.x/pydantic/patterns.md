...
own [named schema](/v0.x/pydantic/openapi/#naming-and-collisions)
...
that uses it. See [Parameters](/v0.x/pydantic/parameters/#dependencies) and
[building a Q up conditionally](/v0.x/orm/filtering/#building-one-up).
...
[`SecretStr`](/v0.x/pydantic/types/#pydantics-own-types) keeps the key out of
...
A [model validator](/v0.x/pydantic/validators/#model_validator) is the right place.
...
[customising the 422](/v0.x/pydantic/errors/#customising-the-response).
...
[constraint](/v0.x/orm/meta/#constraints) and catch the error.
