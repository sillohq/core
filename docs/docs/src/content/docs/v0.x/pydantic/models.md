...
This is what Sillo calls for a [request body](/v0.x/pydantic/request-models/).
...
for the response. See [Patterns](/v0.x/pydantic/patterns/).
...
[model validator](/v0.x/pydantic/validators/) or a defaulted field depends on an
...
[Types](/v0.x/pydantic/types/#coercion).
...
[Validators](/v0.x/pydantic/validators/).
...
`model_json_schema()` is what [OpenAPI generation](/v0.x/pydantic/openapi/) is built
