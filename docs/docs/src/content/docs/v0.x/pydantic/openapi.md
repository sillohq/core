...
The [parameter markers](/v0.x/pydantic/parameters/) take the same constraint
...
[Generic models](/v0.x/pydantic/models/#generic-models) get generated names
...
[Nested models](/v0.x/pydantic/nested/#discriminated-unions).
...
It does not make the route private. Use [auth](/v0.x/guides/protecting-routes/) for
that. An undocumented endpoint is still an endpoint.

## Viewing it

The [documentation UI](/v0.x/guides/openapi/documentation-ui/) renders it, and the
raw document is served alongside. See
[the OpenAPI guides](/v0.x/guides/openapi/) for configuring the title, version,
...
- **A [custom serialiser](/v0.x/pydantic/serialization/#custom-serialisers)** can
