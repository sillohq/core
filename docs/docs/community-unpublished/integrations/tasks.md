...
description: A robust background task management system for sillo applications.
---

# Background Tasks

A robust background task management system for sillo applications, providing a simple yet powerful way to run, monitor, and manage asynchronous tasks.
...
-  Seamless integration with sillo dependency injection
...
Follow these steps to integrate background tasks into your sillo application:
...
```python title="Dependency Injection (Best Practice)"
...
```python title="Dependency Injection (Recommended)"
from sillo_contrib.tasks import TaskDependency, TaskStatus
...
```python title="Alternative: Task Manager"
from sillo_contrib.tasks import TaskStatus
...
sillo Tasks integrates seamlessly with sillo's dependency injection system for a more elegant solution.
...
```python title="Alternative: create_task"
from sillo_contrib.tasks import create_task
...
```python title="Dependency Injection"
from sillo_contrib.tasks import TaskDependency
...
```python
from sillo_contrib.tasks import TaskConfig, setup_tasks
...
```python
from sillo_contrib.tasks import Task
...
```python
from sillo_contrib.tasks import update_task_progress
...
```python
from sillo_contrib.tasks import TaskError
