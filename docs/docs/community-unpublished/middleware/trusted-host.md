---
title: Trusted Host Middleware
description: A lightweight production-ready trusted host middleware for the sillo framework.
---

# Trusted Host Middleware

A lightweight, production‑ready trusted host middleware for the sillo ASGI framework.
...
```python
import os
from sillo_contrib.trusted import TrustedHost
