...
class WebSocketException(Exception):
    ...
    from a WebSocket handler, the framework catches it and sends a WebSocketContext
    ...
    Note:
        WebSocket close codes are defined in RFC 6455 and the IANA WebSocketContext
