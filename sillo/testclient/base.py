...
from sillo.testclient._internal.websockets import WebSocketTestSession
from sillo.testclient.exceptions import UpgradeException
from sillo.types import ASGIApp
...
try:
    ...
    raise RuntimeError(
        "The sillo.testclient module requires the httpx package to be installed.\n"
